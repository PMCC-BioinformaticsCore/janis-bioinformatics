...
class StrelkaSomaticBase(CommandTool):
    ...
    def inputs(self):
        return [
            ...
            ToolInput(tag="normalBam", input_type=BamBai(), prefix="--normalBam=", separate_value_from_prefix=False,
                      position=1,
                      doc="Normal sample BAM or CRAM file. (no default)"),
            ToolInput(tag="tumorBam", input_type=BamBai(), prefix="--tumourBam=", separate_value_from_prefix=False,
                      position=1,
                      doc="(--tumorBam)  Tumor sample BAM or CRAM file. [required] (no default)"),

            ToolInput(tag="reference", input_type=FastaWithDict(), prefix="--referenceFasta=", position=1,
                      separate_value_from_prefix=False, doc=" samtools-indexed reference fasta file [required]"),
            ToolInput(tag="rundir", input_type=Filename(), prefix="--runDir=", separate_value_from_prefix=False,
                      position=1,
            ...
            ToolInput(tag="region", input_type=Bed(optional=True), prefix="--region=", separate_value_from_prefix=False,
                      position=1,
            ...
            ToolInput(tag="outputcallableregions", input_type=Bed(optional=True), prefix="--outputCallableRegions",
                      position=1,
                      separate_value_from_prefix=True,
                      doc=" Output a bed file describing somatic callable regions of the genome"),
            ToolInput(tag="indelCandidates", input_type=VcfTabix(optional=True), prefix="--indelCandidates=", position=1,
            ...
            ToolInput(tag="forcedgt", input_type=File(optional=True), prefix="--forcedGT=",
                      separate_value_from_prefix=False, position=1,
            ...
            ToolInput(tag="targeted", input_type=Boolean(optional=True), prefix="--targeted",
            ...
            ToolInput(tag="noisevcf", input_type=File(optional=True), prefix="--noiseVcf=",
                      separate_value_from_prefix=False, position=1,
                      doc="Noise vcf file (submit argument multiple times for more than one file)"),
            ToolInput(tag="scansizemb", input_type=Int(optional=True), prefix="--scanSizeMb=",
                      separate_value_from_prefix=False, position=1,
            ...
            ToolInput(tag="retaintempfiles", input_type=Boolean(optional=True), default=False, position=1,
                      prefix="--retainTempFiles", separate_value_from_prefix=True,
                      doc="Keep all temporary files (for workflow debugging)"),
            ToolInput(tag="disableevs", input_type=Boolean(optional=True), prefix="--disableEVS", position=1,
                      separate_value_from_prefix=True, doc="Disable empirical variant scoring (EVS)."),
            ToolInput(tag="reportevsfeatures", input_type=Boolean(optional=True), prefix="--reportEVSFeatures",
                      position=1,
                      separate_value_from_prefix=True,
                      doc=" Report all empirical variant scoring features in VCF output."),
            ToolInput(tag="snvscoringmodelfile", input_type=File(optional=True), prefix="--snvScoringModelFile=",
                      position=1,
                      separate_value_from_prefix=False,
                      doc=" Provide a custom empirical scoring model file for SNVs "
                          "(default: /opt/strelka/share/config/somaticSNVScoringM odels.json)"),
            ToolInput(tag="indelscoringmodelfile", input_type=File(optional=True), prefix="--indelScoringModelFile=",
                      position=1,
                      separate_value_from_prefix=False,
