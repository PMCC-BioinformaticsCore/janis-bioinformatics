...
class GridssBase(BioinformaticsTool):
    ...
    def inputs(self) -> List[ToolInput]:
        return [
            ...
            ToolInput("outputFilename", Filename(extension=".vcf"), prefix="OUTPUT=", separate_value_from_prefix=False,
                      doc="(O=) VCF structural variation calls. Required."),
            ToolInput("reference", FastaWithDict(), prefix="REFERENCE_SEQUENCE=", separate_value_from_prefix=False),

            ToolInput("bams", Array(Bam()), prefix="INPUT=", separate_value_from_prefix=False,
            ...
            ToolInput("inputLabel", String(optional=True), prefix="INPUT_LABEL=", separate_value_from_prefix=False,
            ...
            ToolInput("inputMaxFragmentSize", Int(optional=True), prefix="INPUT_MAX_FRAGMENT_SIZE=",
                      separate_value_from_prefix=False,
                      doc="Per input maximum concordant fragment size. Default value: null. "
                          "This option may be specified 0 or more times."),
            ToolInput("inputMinFragmentSize", Int(optional=True), prefix="INPUT_MIN_FRAGMENT_SIZE=",
                      separate_value_from_prefix=False,
                      doc="Per input minimum concordant fragment size. Default value: null. "
                          "This option may be specified 0 or more times."),
            ToolInput("readPairConcordantPercent", Float(optional=True), prefix="READ_PAIR_CONCORDANT_PERCENT=",
                      separate_value_from_prefix=False,
            ...
            ToolInput("blacklist", Bed(), prefix="BLACKLIST=", separate_value_from_prefix=False,
            ...
            ToolInput("configurationFile", File(optional=True), prefix="CONFIGURATION_FILE=", separate_value_from_prefix=False,
                      doc="(C=File) gridss configuration file containing overrides Default value: null."),
            ToolInput("workerThreads", Int(optional=True), prefix="WORKER_THREADS=", separate_value_from_prefix=False,
                      doc="(THREADS=Integer  Number of worker threads to spawn. Defaults to number of cores available. "
                          ...
                          "This option can be set to 'null' to clear the default value."),
            ToolInput("workingDir", String(optional=True), prefix="WORKING_DIR=", default=".", separate_value_from_prefix=False,
            ...
            ToolInput("ignoreDuplicates", Boolean(optional=True), prefix="IGNORE_DUPLICATES=", separate_value_from_prefix=False,
