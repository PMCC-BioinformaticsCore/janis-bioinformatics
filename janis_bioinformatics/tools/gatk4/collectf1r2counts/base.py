...
class GatkCollectF1R2CountsBase(Gatk4ToolBase, ABC):
    @classmethod
    def gatk_command(cls):
        return "CollectF1R2Counts"

    def friendly_name(self) -> str:
        return "GATK4: CollectF1R2Counts"

    def tool(self) -> str:
        return "Gatk4CollectF1R2Counts"
    ...
    def inputs(self):
        return [
            ...
            ToolInput(
                ...
                prefix="--output",
                separate_value_from_prefix=True,
                doc=InputDocumentation(doc="(-O) Output .tar.gz file Required."),
            ),
            ToolInput(
                tag="reference",
                input_type=String(optional=True),
    ...
    def metadata(self):
        return ToolMetadata(
            contributors=[],
            dateCreated=datetime.fromisoformat("2020-05-18T14:07:00.127978"),
            dateUpdated=datetime.fromisoformat("2020-05-18T14:07:00.127979"),
            documentation="USAGE: CollectF1R2Counts [arguments]\nCollect F1R2 read counts for the Mutect2 orientation bias mixture model filter\nVersion:4.1.3.0\n",
        )
