...
class GatkAddCommentsToBamBase(Gatk4ToolBase, ABC):
    @classmethod
    def gatk_command(cls):
        return "AddCommentsToBam"

    def friendly_name(self) -> str:
        return "GATK4: AddCommentsToBam"

    def tool(self) -> str:
        return "Gatk4AddCommentsToBam"
        ...
        return [
            ToolInput(
                ...
                doc=InputDocumentation(
                    doc="(-C) Comments to add to the BAM file This argument must be specified at least once. Required."
                ),
            ),
            ToolInput(
                tag="inp",
                ...
                separate_value_from_prefix=True,
                doc=InputDocumentation(
                    doc="(-I) Input BAM file to add a comment to the header Required."
                ),
            ),
            ToolInput(
                tag="outputFilename",
                ...
                separate_value_from_prefix=True,
                doc=InputDocumentation(
                    doc="(-O) Output BAM file to write results Required."
                ),
            ),
            ToolInput(
                tag="arguments_file",
