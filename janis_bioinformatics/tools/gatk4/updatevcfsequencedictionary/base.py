...
class GatkUpdateVCFSequenceDictionaryBase(Gatk4ToolBase, ABC):
    @classmethod
    def gatk_command(cls):
        return "UpdateVCFSequenceDictionary"

    def friendly_name(self) -> str:
        return "GATK4: UpdateVCFSequenceDictionary"

    def tool(self) -> str:
        return "Gatk4UpdateVCFSequenceDictionary"
        ...
        return [
            ToolInput(
                ...
                doc=InputDocumentation(
                    doc="(-O) File to which updated variants should be written Required."
                ),
            ),
            ToolInput(
                tag="variant",
            ...
            ToolInput(
                ...
                separate_value_from_prefix=True,
                doc=InputDocumentation(
                    doc="Force replacement of the dictionary if the input file already has a dictionary Default value: false. Possible values: {true, false} "
                ),
            ),
            ToolInput(
    ...
    def metadata(self):
        return ToolMetadata(
            contributors=[],
            dateCreated=datetime.fromisoformat("2020-05-18T15:08:21.535580"),
            dateUpdated=datetime.fromisoformat("2020-05-18T15:08:21.535581"),
            documentation="USAGE: UpdateVCFSequenceDictionary [arguments]\nUpdates the sequence dictionary in a variant file using the dictionary from another variant, alignment, dictionary, or\nreference file. The dictionary must be valid for all variants in the target file.\nVersion:4.1.3.0\n",
        )
