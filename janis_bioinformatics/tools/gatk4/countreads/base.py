...
class GatkCountReadsBase(Gatk4ToolBase, ABC):
    @classmethod
    def gatk_command(cls):
        return "CountReads"

    def friendly_name(self) -> str:
        return "GATK4: CountReads"

    def tool(self) -> str:
        return "Gatk4CountReads"
    ...
    def metadata(self):
        return ToolMetadata(
            contributors=[],
            dateCreated=datetime.fromisoformat("2020-05-18T14:07:26.451887"),
            dateUpdated=datetime.fromisoformat("2020-05-18T14:07:26.451890"),
            documentation="USAGE: CountReads [arguments]\nCount reads in a SAM/BAM/CRAM file.\nVersion:4.1.3.0\n",
        )
