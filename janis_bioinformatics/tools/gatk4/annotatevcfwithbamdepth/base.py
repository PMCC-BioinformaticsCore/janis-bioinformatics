...
class GatkAnnotateVcfWithBamDepthBase(Gatk4ToolBase, ABC):
    @classmethod
    def gatk_command(cls):
        return "AnnotateVcfWithBamDepth"

    def friendly_name(self) -> str:
        return "GATK4: AnnotateVcfWithBamDepth"

    def tool(self) -> str:
        return "Gatk4AnnotateVcfWithBamDepth"
    ...
    def metadata(self):
        return ToolMetadata(
            contributors=[],
            dateCreated=datetime.fromisoformat("2020-05-18T15:03:17.937690"),
            dateUpdated=datetime.fromisoformat("2020-05-18T15:03:17.937691"),
            documentation="USAGE: AnnotateVcfWithBamDepth [arguments]\nAnnotate a vcf with a bam's read depth at each variant locus\nVersion:4.1.3.0\n",
        )
