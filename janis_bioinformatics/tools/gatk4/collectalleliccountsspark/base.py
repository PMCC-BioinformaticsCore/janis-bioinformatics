...
class GatkCollectAllelicCountsSparkBase(Gatk4ToolBase, ABC):
    @classmethod
    def gatk_command(cls):
        return "CollectAllelicCountsSpark"

    def friendly_name(self) -> str:
        return "GATK4: CollectAllelicCountsSpark"

    def tool(self) -> str:
        return "Gatk4CollectAllelicCountsSpark"
    ...
    def inputs(self):
        return [
            ...
            ToolInput(
                ...
                separate_value_from_prefix=True,
                doc=InputDocumentation(
                    doc="(-O) Output file for allelic counts. Required."
                ),
            ),
            ToolInput(
                tag="reference",
            ...
            ToolInput(
                ...
                separate_value_from_prefix=True,
                doc=InputDocumentation(
                    doc="(-DF)  Read filters to be disabled before analysis  This argument may be specified 0 or more times. Default value: null. Possible Values: {MappedReadFilter, MappingQualityReadFilter, NonZeroReferenceLengthAlignmentReadFilter, NotDuplicateReadFilter, WellformedReadFilter}"
                ),
            ),
            ToolInput(
            ...
            ToolInput(
                tag="minimumBaseQuality",
                input_type=Boolean(optional=True),
                prefix="--minimum-base-quality",
                separate_value_from_prefix=True,
                doc=InputDocumentation(
                    doc="Base calls with lower quality will be filtered out of pileups. Default value: 20. "
                ),
            ),
            ToolInput(
                tag="numReducers",
    ...
    def metadata(self):
        return ToolMetadata(
            contributors=[],
            dateCreated=datetime.fromisoformat("2020-05-18T14:06:53.595908"),
            dateUpdated=datetime.fromisoformat("2020-05-18T14:06:53.595910"),
            documentation="USAGE: CollectAllelicCountsSpark [arguments]\nCollects reference and alternate allele counts at specified sites\nVersion:4.1.3.0\n",
        )
