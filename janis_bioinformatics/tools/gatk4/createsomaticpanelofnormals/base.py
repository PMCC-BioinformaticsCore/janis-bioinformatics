...
class GatkCreateSomaticPanelOfNormalsBase(Gatk4ToolBase, ABC):
    @classmethod
    def gatk_command(cls):
        return "CreateSomaticPanelOfNormals"

    def friendly_name(self) -> str:
        return "GATK4: CreateSomaticPanelOfNormals"

    def tool(self) -> str:
        return "Gatk4CreateSomaticPanelOfNormals"
    ...
    def inputs(self):
        return [
            ToolInput(
                ...
                doc=InputDocumentation(doc="(-O) Output vcf Required."),
            ),
            ToolInput(
                tag="variant",
            ...
            ToolInput(
                tag="maxGermlineProbability",
                input_type=Double(optional=True),
                prefix="--max-germline-probability",
                separate_value_from_prefix=True,
                doc=InputDocumentation(
                    doc=" Skip genotypes with germline probability greater than this value  Default value: 0.5. "
                ),
            ),
            ToolInput(
                tag="minSampleCount",
                ...
                separate_value_from_prefix=True,
                doc=InputDocumentation(
                    doc="Number of samples containing a variant site required to include it in the panel of normals.  Default value: 2. "
                ),
            ),
            ToolInput(
                tag="quiet",
    ...
    def metadata(self):
        return ToolMetadata(
            contributors=[],
            dateCreated=datetime.fromisoformat("2020-05-18T15:06:07.286811"),
            dateUpdated=datetime.fromisoformat("2020-05-18T15:06:07.286813"),
