...
class GatkCollectAllelicCountsBase(Gatk4ToolBase, ABC):
    @classmethod
    def gatk_command(cls):
        return "CollectAllelicCounts"

    def friendly_name(self) -> str:
        return "GATK4: CollectAllelicCounts"

    def tool(self) -> str:
        return "Gatk4CollectAllelicCounts"
    ...
    def metadata(self):
        return ToolMetadata(
            contributors=[],
            dateCreated=datetime.fromisoformat("2020-05-18T14:06:47.008410"),
            dateUpdated=datetime.fromisoformat("2020-05-18T14:06:47.008411"),
            documentation="USAGE: CollectAllelicCounts [arguments]\nCollects reference and alternate allele counts at specified sites\nVersion:4.1.3.0\n",
        )
