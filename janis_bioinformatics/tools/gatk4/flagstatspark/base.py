...
class GatkFlagStatSparkBase(Gatk4ToolBase, ABC):
    @classmethod
    def gatk_command(cls):
        return "FlagStatSpark"

    def friendly_name(self) -> str:
        return "GATK4: FlagStatSpark"

    def tool(self) -> str:
        return "Gatk4FlagStatSpark"
    ...
    def metadata(self):
        return ToolMetadata(
            contributors=[],
            dateCreated=datetime.fromisoformat("2020-05-18T14:12:22.125941"),
            dateUpdated=datetime.fromisoformat("2020-05-18T14:12:22.125942"),
            documentation="USAGE: FlagStatSpark [arguments]\nSpark tool to accumulate flag statistics given a BAM file, e.g. total number of reads with QC failure flag set,number of\nduplicates, percentage mapped etc.\nVersion:4.1.3.0\n",
        )
