...
class GatkGenotypeGVCFsBase(Gatk4ToolBase, ABC):
    @classmethod
    def gatk_command(cls):
        return "GenotypeGVCFs"

    def friendly_name(self) -> str:
        return "GATK4: GenotypeGVCFs"

    def tool(self) -> str:
        return "Gatk4GenotypeGVCFs"
    ...
    def inputs(self):
        return [
            ...
            ToolInput(
                tag="alleleFractionError",
                input_type=Boolean(optional=True),
                prefix="--allele-fraction-error",
                separate_value_from_prefix=True,
                doc=InputDocumentation(doc="Default value: 0.001. "),
            ),
            ToolInput(
            ...
            ToolInput(
                tag="includeNonVariantSites",
                input_type=Boolean(optional=True),
                prefix="--include-non-variant-sites",
                separate_value_from_prefix=True,
                doc=InputDocumentation(
                    doc="(-all-sites)  Include loci found to be non-variant after genotyping  Default value: false. Possible values: {true, false} "
                ),
            ),
            ToolInput(
            ...
            ToolInput(
                tag="inputIsSomatic",
                input_type=Boolean(optional=True),
                prefix="--input-is-somatic",
                separate_value_from_prefix=True,
                doc=InputDocumentation(
                    doc="Finalize input GVCF according to somatic (i.e. Mutect2) TLODs (BETA feature) Default value: false. Possible values: {true, false} "
                ),
            ),
            ToolInput(
            ...
            ToolInput(
                tag="keepCombinedRawAnnotations",
                input_type=Boolean(optional=True),
                prefix="--keep-combined-raw-annotations",
                separate_value_from_prefix=True,
                doc=InputDocumentation(
                    doc="(-keep-combined)  If specified, keep the combined raw annotations  Default value: false. Possible values: {true, false} "
                ),
            ),
            ToolInput(
                tag="lenient",
            ...
            ToolInput(
                ...
                separate_value_from_prefix=True,
                doc=InputDocumentation(
                    doc="(-merge-input-intervals)  Boolean flag to import all data in between intervals.  Default value: false. Possible values: {true, false} "
                ),
            ),
            ToolInput(
            ...
            ToolInput(
                ...
                separate_value_from_prefix=True,
                doc=InputDocumentation(
                    doc="(-emit-lod)  LOD threshold to emit variant to VCF.  Default value: 3.5. "
                ),
            ),
            ToolInput(
                tag="useJdkDeflater",
            ...
            ToolInput(
                tag="onlyOutputCallsStartingInIntervals",
                input_type=Boolean(optional=True),
                prefix="--only-output-calls-starting-in-intervals",
                separate_value_from_prefix=True,
                doc=InputDocumentation(
                    doc=" Restrict variant output to sites that start within provided intervals  Default value: false. Possible values: {true, false} "
                ),
            ),
            ToolInput(
                tag="showhidden",
    ...
    def metadata(self):
        return ToolMetadata(
            contributors=[],
            dateCreated=datetime.fromisoformat("2020-05-18T15:01:50.590184"),
            dateUpdated=datetime.fromisoformat("2020-05-18T15:01:50.590185"),
            documentation="USAGE: GenotypeGVCFs [arguments]\nPerform joint genotyping on a single-sample GVCF from HaplotypeCaller or a multi-sample GVCF from CombineGVCFs or\nGenomicsDBImport\nVersion:4.1.3.0\n",
        )
