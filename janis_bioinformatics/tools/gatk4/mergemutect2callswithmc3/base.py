...
class GatkMergeMutect2CallsWithMC3Base(Gatk4ToolBase, ABC):
    @classmethod
    def gatk_command(cls):
        return "MergeMutect2CallsWithMC3"

    def friendly_name(self) -> str:
        return "GATK4: MergeMutect2CallsWithMC3"

    def tool(self) -> str:
        return "Gatk4MergeMutect2CallsWithMC3"
    ...
    def inputs(self):
        return [
            ...
            ToolInput(
                ...
                prefix="--output",
                separate_value_from_prefix=True,
                doc=InputDocumentation(doc="(-O) Merged vcf. Required."),
            ),
            ToolInput(
                tag="truth",
                input_type=String(optional=True),
    ...
    def metadata(self):
        return ToolMetadata(
            contributors=[],
            dateCreated=datetime.fromisoformat("2020-05-18T15:05:01.836919"),
            dateUpdated=datetime.fromisoformat("2020-05-18T15:05:01.836920"),
            documentation="**EXPERIMENTAL FEATURE - USE AT YOUR OWN RISK**\nUSAGE: MergeMutect2CallsWithMC3 [arguments]\nUNSUPPORTED.  FOR EVALUATION ONLY. Merge M2 (eval) calls with MC3 (truth)\nVersion:4.1.3.0\n",
        )
