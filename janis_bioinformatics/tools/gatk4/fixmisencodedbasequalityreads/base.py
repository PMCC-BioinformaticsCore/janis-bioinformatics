...
class GatkFixMisencodedBaseQualityReadsBase(Gatk4ToolBase, ABC):
    @classmethod
    def gatk_command(cls):
        return "FixMisencodedBaseQualityReads"

    def friendly_name(self) -> str:
        return "GATK4: FixMisencodedBaseQualityReads"

    def tool(self) -> str:
        return "Gatk4FixMisencodedBaseQualityReads"
    ...
    def metadata(self):
        return ToolMetadata(
            contributors=[],
            dateCreated=datetime.fromisoformat("2020-05-18T14:57:14.096080"),
            dateUpdated=datetime.fromisoformat("2020-05-18T14:57:14.096081"),
            documentation="USAGE: FixMisencodedBaseQualityReads [arguments]\nFixes Illumina base quality scores in a SAM/BAM/CRAM file\nVersion:4.1.3.0\n",
        )
