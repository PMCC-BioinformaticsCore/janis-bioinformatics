...
class GatkCheckTerminatorBlockBase(Gatk4ToolBase, ABC):
    @classmethod
    def gatk_command(cls):
        return "CheckTerminatorBlock"

    def friendly_name(self) -> str:
        return "GATK4: CheckTerminatorBlock"

    def tool(self) -> str:
        return "Gatk4CheckTerminatorBlock"
        ...
        return [
            ToolInput(
                ...
                doc=InputDocumentation(
                    doc="(-I) The block compressed file to check. Required."
                ),
            ),
            ToolInput(
                tag="arguments_file",
    ...
    def metadata(self):
        return ToolMetadata(
            contributors=[],
            dateCreated=datetime.fromisoformat("2020-05-18T14:08:47.539478"),
            dateUpdated=datetime.fromisoformat("2020-05-18T14:08:47.539479"),
            documentation="b'USAGE: CheckTerminatorBlock [arguments]\nAsserts the provided gzip file's (e.g., BAM) last block is well-formed; RC 100 otherwise\nVersion:4.1.3.0\n",
        )
