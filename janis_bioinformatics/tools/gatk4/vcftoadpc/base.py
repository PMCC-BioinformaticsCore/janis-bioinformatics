...
class GatkVcfToAdpcBase(Gatk4ToolBase, ABC):
    @classmethod
    def gatk_command(cls):
        return "VcfToAdpc"

    def friendly_name(self) -> str:
        return "GATK4: VcfToAdpc"

    def tool(self) -> str:
        return "Gatk4VcfToAdpc"
        ...
        return [
            ToolInput(
                ...
                doc=InputDocumentation(
                    doc="(-O) The output (adpc.bin) file to write. Required."
                ),
            ),
            ToolInput(
                tag="vcf",
                ...
                prefix="--VCF",
                separate_value_from_prefix=True,
                doc=InputDocumentation(doc="The Input VCF Required."),
            ),
            ToolInput(
                tag="arguments_file",
                input_type=File(optional=True),
