...
class GatkClipReadsBase(Gatk4ToolBase, ABC):
    @classmethod
    def gatk_command(cls):
        return "ClipReads"

    def friendly_name(self) -> str:
        return "GATK4: ClipReads"

    def tool(self) -> str:
        return "Gatk4ClipReads"
    ...
    def inputs(self):
        return [
            ...
            ToolInput(
                ...
                prefix="--output",
                separate_value_from_prefix=True,
                doc=InputDocumentation(doc="(-O) BAM output file Required."),
            ),
            ToolInput(
            ...
            ToolInput(
                tag="clipRepresentation",
                input_type=Boolean(optional=True),
                prefix="--clip-representation",
                separate_value_from_prefix=True,
                doc=InputDocumentation(
                    doc="(-CR)  How should we actually clip the bases?  Default value: WRITE_NS. Possible values: {WRITE_NS, WRITE_Q0S, WRITE_NS_Q0S, SOFTCLIP_BASES, HARDCLIP_BASES, REVERT_SOFTCLIPPED_BASES} "
                ),
            ),
            ToolInput(
                tag="clipSequence",
                ...
                separate_value_from_prefix=True,
                doc=InputDocumentation(
                    doc="(-X) Remove sequences within reads matching this sequence This argument may be specified 0 or more times. Default value: null. "
                ),
            ),
            ToolInput(
                tag="clipSequencesFile",
                input_type=String(optional=True),
                prefix="--clip-sequences-file",
                separate_value_from_prefix=True,
                doc=InputDocumentation(
                    doc="(-XF)  Remove sequences within reads matching the sequences in this FASTA file  Default value: null. "
                ),
            ),
            ToolInput(
            ...
            ToolInput(
                ...
                separate_value_from_prefix=True,
                doc=InputDocumentation(
                    doc="(-CT) String indicating machine cycles to clip from the reads Default value: null."
                ),
            ),
            ToolInput(
            ...
            ToolInput(
                tag="outputStatistics",
                input_type=File(optional=True),
                prefix="--output-statistics",
                separate_value_from_prefix=True,
                doc=InputDocumentation(
                    doc="(-os) File to output statistics Default value: null."
                ),
            ),
            ToolInput(
                tag="qTrimmingThreshold",
                input_type=Int(optional=True),
                prefix="--q-trimming-threshold",
                separate_value_from_prefix=True,
                doc=InputDocumentation(
                    doc="(-QT)  If provided, the Q-score clipper will be applied  Default value: -1. "
                ),
            ),
            ToolInput(
                tag="quiet",
            ...
            ToolInput(
                ...
                prefix="--read",
                separate_value_from_prefix=True,
                doc=InputDocumentation(doc="(-read) Default value: null."),
            ),
            ToolInput(
                tag="readFilter",
                input_type=String(optional=True),
