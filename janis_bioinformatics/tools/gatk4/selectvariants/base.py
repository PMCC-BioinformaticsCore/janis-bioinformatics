...
class GatkSelectVariantsBase(Gatk4ToolBase, ABC):
    @classmethod
    ...
    def inputs(self):
        return [
            ToolInput(
                ...
                doc=InputDocumentation(doc="(-O) Required."),
            ),
            ToolInput(
                tag="variant",
            ...
            ToolInput(
                ...
                separate_value_from_prefix=True,
                doc=InputDocumentation(
                    doc="(-conc)  Output variants also called in this comparison track  Default value: null. "
                ),
            ),
            ToolInput(
            ...
            ToolInput(
                ...
                separate_value_from_prefix=True,
                doc=InputDocumentation(
                    doc="(-disc)  Output variants not called in this comparison track  Default value: null. "
                ),
            ),
            ToolInput(
                ...
                separate_value_from_prefix=True,
                doc=InputDocumentation(
                    doc="(-DGA)  Genotype annotations to drop from output vcf.  Annotations to be dropped are specified by their key.  This argument may be specified 0 or more times. Default value: null. "
                ),
            ),
            ToolInput(
                ...
                separate_value_from_prefix=True,
                doc=InputDocumentation(
                    doc="(-DA)  Info annotations to drop from output vcf.  Annotations to be dropped are specified by their key.  This argument may be specified 0 or more times. Default value: null. "
                ),
            ),
            ToolInput(
                tag="excludeFiltered",
            ...
            ToolInput(
                ...
                separate_value_from_prefix=True,
                doc=InputDocumentation(
                    doc="(-xl-ids) List of variant rsIDs to exclude This argument may be specified 0 or more times. Default value: null. "
                ),
            ),
            ToolInput(
            ...
            ToolInput(
                ...
                separate_value_from_prefix=True,
                doc=InputDocumentation(
                    doc="(-xl-se)  List of sample expressions to exclude  This argument may be specified 0 or more times. Default value: null. "
                ),
            ),
            ToolInput(
                ...
                separate_value_from_prefix=True,
                doc=InputDocumentation(
                    doc="(-xl-sn)  Exclude genotypes from this sample  This argument may be specified 0 or more times. Default value: null. "
                ),
            ),
            ToolInput(
                tag="gatkConfigFile",
            ...
            ToolInput(
                ...
                separate_value_from_prefix=True,
                doc=InputDocumentation(
                    doc="(-invert-select)  Invert the selection criteria for -select  Default value: false. Possible values: {true, false} "
                ),
            ),
            ToolInput(
                tag="keepIds",
                ...
                separate_value_from_prefix=True,
                doc=InputDocumentation(
                    doc="(-ids) List of variant rsIDs to select This argument may be specified 0 or more times. Default value: null. "
                ),
            ),
            ToolInput(
                tag="keepOriginalAc",
            ...
            ToolInput(
                ...
                prefix="--pedigree",
                separate_value_from_prefix=True,
                doc=InputDocumentation(doc="(-ped) Pedigree file Default value: null."),
            ),
            ToolInput(
                tag="preserveAlleles",
                input_type=Boolean(optional=True),
            ...
            ToolInput(
                ...
                separate_value_from_prefix=True,
                doc=InputDocumentation(
                    doc="(-se)  Regular expression to select multiple samples  This argument may be specified 0 or more times. Default value: null. "
                ),
            ),
            ToolInput(
                tag="sampleName",
                ...
                separate_value_from_prefix=True,
                doc=InputDocumentation(
                    doc="(-sn) Include genotypes from this sample This argument may be specified 0 or more times. Default value: null. "
                ),
            ),
            ToolInput(
            ...
            ToolInput(
                ...
                separate_value_from_prefix=True,
                doc=InputDocumentation(
                    doc="(-fraction)  Select a fraction of variants at random from the input  Default value: 0.0. "
                ),
            ),
            ToolInput(
                ...
                separate_value_from_prefix=True,
                doc=InputDocumentation(
                    doc="(-xl-select-type)  Do not select certain type of variants from the input file  This argument may be specified 0 or more times. Default value: null. Possible values: {NO_VARIATION, SNP, MNP, INDEL, SYMBOLIC, MIXED} "
                ),
            ),
            ToolInput(
                ...
                separate_value_from_prefix=True,
                doc=InputDocumentation(
                    doc="(-select-type)  Select only a certain type of variants from the input file  This argument may be specified 0 or more times. Default value: null. Possible values: {NO_VARIATION, SNP, MNP, INDEL, SYMBOLIC, MIXED} "
                ),
            ),
            ToolInput(
                ...
                separate_value_from_prefix=True,
                doc=InputDocumentation(
                    doc="(-select)  One or more criteria to use when selecting the data  This argument may be specified 0 or more times. Default value: null. "
                ),
            ),
            ToolInput(
    ...
    def metadata(self):
        return ToolMetadata(
            contributors=[],
            dateCreated=datetime.fromisoformat("2020-05-18T15:08:00.487312"),
            dateUpdated=datetime.fromisoformat("2020-05-18T15:08:00.487313"),
