...
class GatkCompareDuplicatesSparkBase(Gatk4ToolBase, ABC):
    @classmethod
    def gatk_command(cls):
        return "CompareDuplicatesSpark"

    def friendly_name(self) -> str:
        return "GATK4: CompareDuplicatesSpark"

    def tool(self) -> str:
        return "Gatk4CompareDuplicatesSpark"
    ...
    def inputs(self):
        return [
            ...
            ToolInput(
                ...
                prefix="--input2",
                separate_value_from_prefix=True,
                doc=InputDocumentation(doc="(-I2) The second BAM Required."),
            ),
            ToolInput(
            ...
            ToolInput(
                ...
                separate_value_from_prefix=True,
                doc=InputDocumentation(
                    doc="(-O) If output is given, the tool will return a bam with all the mismatching duplicate groups in the first specified file  Default value: null. "
                ),
            ),
            ToolInput(
            ...
            ToolInput(
                ...
                separate_value_from_prefix=True,
                doc=InputDocumentation(
                    doc="(-O2) If output is given, the tool will return a bam with all the mismatching duplicate groups in the second specified input file  Default value: null. "
                ),
            ),
            ToolInput(
                tag="printSummary",
            ...
            ToolInput(
                ...
                separate_value_from_prefix=True,
                doc=InputDocumentation(
                    doc="Throw error if any differences were found Default value: false. Possible values: {true, false} "
                ),
            ),
            ToolInput(
                tag="tmpDir",
    ...
    def metadata(self):
        return ToolMetadata(
            contributors=[],
            dateCreated=datetime.fromisoformat("2020-05-18T14:11:30.876608"),
            dateUpdated=datetime.fromisoformat("2020-05-18T14:11:30.876609"),
            documentation="**BETA FEATURE - WORK IN PROGRESS**\nUSAGE: CompareDuplicatesSpark [arguments]\nDetermine if two potentially identical BAMs have the same duplicate reads. This tool is useful for checking if two BAMs\nthat seem identical have the same reads marked as duplicates.\nVersion:4.1.3.0\n",
        )
