...
class GatkPathSeqPipelineSparkBase(Gatk4ToolBase, ABC):
    @classmethod
    def gatk_command(cls):
        return "PathSeqPipelineSpark"

    def friendly_name(self) -> str:
        return "GATK4: PathSeqPipelineSpark"

    def tool(self) -> str:
        return "Gatk4PathSeqPipelineSpark"
    ...
    def inputs(self):
        return [
            ...
            ToolInput(
                ...
                separate_value_from_prefix=True,
                doc=InputDocumentation(
                    doc="(-MI)  on a Spark cluster, this must be distributed to local disk on each node.  Required. "
                ),
            ),
            ToolInput(
                tag="microbeFasta",
                ...
                separate_value_from_prefix=True,
                doc=InputDocumentation(
                    doc="(-MF) Reference corresponding to the microbe reference image file Required."
                ),
            ),
            ToolInput(
                tag="scoresOutput",
                ...
                separate_value_from_prefix=True,
                doc=InputDocumentation(
                    doc="(-SO) URI for the taxonomic scores output Required."
                ),
            ),
            ToolInput(
                tag="taxonomyFile",
                ...
                separate_value_from_prefix=True,
                doc=InputDocumentation(
                    doc="(-T) URI to the microbe reference taxonomy database built using PathSeqBuildReferenceTaxonomy Required. "
                ),
            ),
            ToolInput(
            ...
            ToolInput(
                tag="bwaScoreThreshold",
                input_type=Int(optional=True),
                prefix="--bwa-score-threshold",
                separate_value_from_prefix=True,
                doc=InputDocumentation(
                    doc="(-bwa-score-threshold)  Minimum score threshold for microbe alignments  Default value: 30. "
                ),
            ),
            ToolInput(
                tag="conf",
            ...
            ToolInput(
                tag="divideByGenomeLength",
                input_type=Boolean(optional=True),
                prefix="--divide-by-genome-length",
                separate_value_from_prefix=True,
                doc=InputDocumentation(
                    doc="(-divide-by-genome-length)  Divide abundance scores by each taxon's reference genome length (in millions)  Default value: false. Possible values: {true, false} "
                ),
            ),
            ToolInput(
                tag="dustMaskQuality",
                ...
                separate_value_from_prefix=True,
                doc=InputDocumentation(
                    doc="(-dust-mask-quality)  Base quality to assign low-complexity bases  Default value: 2. "
                ),
            ),
            ToolInput(
                tag="dustT",
                ...
                separate_value_from_prefix=True,
                doc=InputDocumentation(
                    doc="(-dust-t) DUST algorithm score threshold Default value: 20.0."
                ),
            ),
            ToolInput(
                tag="dustWindow",
                ...
                separate_value_from_prefix=True,
                doc=InputDocumentation(
                    doc="(-dust-window)  DUST algorithm window size  Default value: 64. "
                ),
            ),
            ToolInput(
            ...
            ToolInput(
                ...
                separate_value_from_prefix=True,
                doc=InputDocumentation(doc="(-FI)  node.  Default value: null. "),
            ),
            ToolInput(
                tag="filterBwaSeedLength",
                input_type=Int(optional=True),
                prefix="--filter-bwa-seed-length",
                separate_value_from_prefix=True,
                doc=InputDocumentation(
                    doc="(-filter-bwa-seed-length)  Minimum seed length for the host BWA alignment.  Default value: 19. "
                ),
            ),
            ToolInput(
                tag="filterDuplicates",
                input_type=Boolean(optional=True),
                prefix="--filter-duplicates",
                separate_value_from_prefix=True,
                doc=InputDocumentation(
                    doc="(-filter-duplicates)  Filter duplicate reads  Default value: true. Possible values: {true, false} "
                ),
            ),
            ToolInput(
                tag="filterMetrics",
                ...
                separate_value_from_prefix=True,
                doc=InputDocumentation(
                    doc="(-FM) Log counts of filtered reads to this file Default value: null."
                ),
            ),
            ToolInput(
                tag="gatkConfigFile",
            ...
            ToolInput(
                ...
                separate_value_from_prefix=True,
                doc=InputDocumentation(
                    doc="(-host-kmer-thresh)  Host kmer count threshold.  Default value: 1. "
                ),
            ),
            ToolInput(
                tag="hostMinIdentity",
                ...
                separate_value_from_prefix=True,
                doc=InputDocumentation(
                    doc="(-host-min-identity)  Host alignment identity score threshold, in bp  Default value: 30. "
                ),
            ),
            ToolInput(
                tag="identityMargin",
                ...
                separate_value_from_prefix=True,
                doc=InputDocumentation(
                    doc="(-identity-margin)  Identity margin, as a fraction of the best hit (between 0 and 1).   Default value: 0.02. "
                ),
            ),
            ToolInput(
            ...
            ToolInput(
                ...
                separate_value_from_prefix=True,
                doc=InputDocumentation(
                    doc="(-is-host-aligned)  Set if the input BAM is aligned to the host  Default value: false. Possible values: {true, false} "
                ),
            ),
            ToolInput(
                tag="kmerFile",
                ...
                separate_value_from_prefix=True,
                doc=InputDocumentation(
                    doc="(-K) Path to host k-mer file generated with PathSeqBuildKmers. K-mer filtering is skipped if this is not specified.  Default value: null. "
                ),
            ),
            ToolInput(
                tag="maxAdapterMismatches",
                input_type=Int(optional=True),
                prefix="--max-adapter-mismatches",
                separate_value_from_prefix=True,
                doc=InputDocumentation(
                    doc="(-max-adapter-mismatches)  Maximum number of mismatches for adapter trimming  Default value: 1. "
                ),
            ),
            ToolInput(
                tag="maxAlternateHits",
                input_type=Int(optional=True),
                prefix="--max-alternate-hits",
                separate_value_from_prefix=True,
                doc=InputDocumentation(
                    doc="(-max-alternate-hits)  Maximum number of alternate microbe alignments  Default value: 5000. "
                ),
            ),
            ToolInput(
                tag="maxMaskedBases",
                ...
                separate_value_from_prefix=True,
                doc=InputDocumentation(
                    doc="(-max-masked-bases)  Max allowable number of masked bases per read  Default value: 2. "
                ),
            ),
            ToolInput(
                tag="microbeMinSeedLength",
                input_type=Int(optional=True),
                prefix="--microbe-min-seed-length",
                separate_value_from_prefix=True,
                doc=InputDocumentation(
                    doc="(-microbe-min-seed-length)  Minimum BWA-MEM seed length for the microbe alignment  Default value: 19. "
                ),
            ),
            ToolInput(
                tag="minAdapterLength",
                input_type=Int(optional=True),
                prefix="--min-adapter-length",
                separate_value_from_prefix=True,
                doc=InputDocumentation(
                    doc="(-min-adapter-length)  Minimum length of adapter sequence to trim  Default value: 12. "
                ),
            ),
            ToolInput(
                tag="minBaseQuality",
                ...
                separate_value_from_prefix=True,
                doc=InputDocumentation(
                    doc="(-min-base-quality)  Bases below this call quality will be masked with 'N'  Default value: 15. "
                ),
            ),
            ToolInput(
                tag="minClippedReadLength",
                input_type=Int(optional=True),
                prefix="--min-clipped-read-length",
                separate_value_from_prefix=True,
                doc=InputDocumentation(
                    doc="(-min-clipped-read-length)  Minimum length of reads after quality trimming  Default value: 31. "
                ),
            ),
            ToolInput(
                tag="minScoreIdentity",
                input_type=Double(optional=True),
                prefix="--min-score-identity",
                separate_value_from_prefix=True,
                doc=InputDocumentation(
                    doc="(-min-score-identity)  Alignment identity score threshold, as a fraction of the read length (between 0 and 1).  Default value: 0.9. "
                ),
            ),
            ToolInput(
                tag="notNormalizedByKingdom",
                input_type=Boolean(optional=True),
                prefix="--not-normalized-by-kingdom",
                separate_value_from_prefix=True,
                doc=InputDocumentation(
                    doc="(-not-normalized-by-kingdom)  If true, normalized abundance scores will be reported as a percentage within their kingdom.  Default value: false. Possible values: {true, false} "
                ),
            ),
            ToolInput(
                tag="numReducers",
            ...
            ToolInput(
                ...
                prefix="--output",
                separate_value_from_prefix=True,
                doc=InputDocumentation(doc="(-O) Output BAM Default value: null."),
            ),
            ToolInput(
            ...
            ToolInput(
                tag="pipelineReadsPerPartition",
                input_type=Int(optional=True),
                prefix="--pipeline-reads-per-partition",
                separate_value_from_prefix=True,
                doc=InputDocumentation(
                    doc="(-pipeline-reads-per-partition)  Number of reads per partition to use for alignment and scoring.  Default value: 5000. "
                ),
            ),
            ToolInput(
                tag="programName",
            ...
            ToolInput(
                tag="qualityThreshold",
                input_type=Int(optional=True),
                prefix="--quality-threshold",
                separate_value_from_prefix=True,
                doc=InputDocumentation(
                    doc="(-quality-threshold)  Quality score trimmer threshold  Default value: 15. "
                ),
            ),
            ToolInput(
                tag="quiet",
            ...
            ToolInput(
                tag="readsperpartitionoutput",
                input_type=Int(optional=True),
                prefix="--readsPerPartitionOutput",
                separate_value_from_prefix=True,
                doc=InputDocumentation(
                    doc=" Number of reads per partition for output. Use this to control the number of sharded BAMs (not --num-reducers).  Default value: 1000000. "
                ),
            ),
            ToolInput(
                tag="reference",
            ...
            ToolInput(
                ...
                separate_value_from_prefix=True,
                doc=InputDocumentation(
                    doc="(-SM) Log counts of mapped and unmapped reads to this file Default value: null."
                ),
            ),
            ToolInput(
                tag="scoreWarnings",
                ...
                separate_value_from_prefix=True,
                doc=InputDocumentation(
                    doc="(-SW) Write accessions found in the reads header but not the taxonomy database to this file Default value: null. "
                ),
            ),
            ToolInput(
                tag="shardedOutput",
            ...
            ToolInput(
                tag="skipQualityFilters",
                input_type=Boolean(optional=True),
                prefix="--skip-quality-filters",
                separate_value_from_prefix=True,
                doc=InputDocumentation(
                    doc="(-skip-quality-filters)  Skip low-quality and low-complexity read filtering  Default value: false. Possible values: {true, false} "
                ),
            ),
            ToolInput(
                tag="sparkMaster",
            ...
            ToolInput(
                tag="filterReadsPerPartition",
                input_type=Int(optional=True),
                prefix="--filter-reads-per-partition",
                separate_value_from_prefix=True,
                doc=InputDocumentation(
                    doc="(-filter-reads-per-partition)  Estimated reads per partition after quality, kmer, and BWA filtering  Default value: 200000. "
                ),
            ),
            ToolInput(
                tag="scoreReadsPerPartitionEstimate",
                input_type=Int(optional=True),
                prefix="--score-reads-per-partition-estimate",
                separate_value_from_prefix=True,
                doc=InputDocumentation(
                    doc="(-score-reads-per-partition-estimate)  Estimated reads per Spark partition for scoring  Default value: 200000. "
                ),
            ),
            ToolInput(
                tag="showhidden",
            ...
            ToolInput(
                tag="skipPreBwaRepartition",
                input_type=Boolean(optional=True),
                prefix="--skip-pre-bwa-repartition",
                separate_value_from_prefix=True,
                doc=InputDocumentation(
                    doc="(-skip-pre-bwa-repartition)  Skip pre-BWA repartition. Set to true for inputs with a high proportion of microbial reads that are not host coordinate-sorted.  Default value: false. Possible values: {true, false}"
                ),
            ),
            ToolInput(
    ...
    def metadata(self):
        return ToolMetadata(
            contributors=[],
            dateCreated=datetime.fromisoformat("2020-05-18T14:54:26.167626"),
            dateUpdated=datetime.fromisoformat("2020-05-18T14:54:26.167626"),
            documentation="USAGE: PathSeqPipelineSpark [arguments]\nCombined tool that performs all PathSeq steps: read filtering, microbe reference alignment and abundance scoring\nVersion:4.1.3.0\n",
        )
