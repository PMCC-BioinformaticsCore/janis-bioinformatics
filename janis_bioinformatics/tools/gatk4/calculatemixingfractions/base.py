...
class GatkCalculateMixingFractionsBase(Gatk4ToolBase, ABC):
    @classmethod
    def gatk_command(cls):
        return "CalculateMixingFractions"

    def friendly_name(self) -> str:
        return "GATK4: CalculateMixingFractions"

    def tool(self) -> str:
        return "Gatk4CalculateMixingFractions"
        ...
        return [
            ToolInput(
                ...
                doc=InputDocumentation(
                    doc="(-O) The output table of samplemixing fractions Required."
                ),
            ),
            ToolInput(
                tag="variant",
    ...
    def metadata(self):
        return ToolMetadata(
            contributors=[],
            dateCreated=datetime.fromisoformat("2020-05-18T15:03:40.843373"),
            dateUpdated=datetime.fromisoformat("2020-05-18T15:03:40.843375"),
            documentation="USAGE: CalculateMixingFractions [arguments]\nCalculate proportions of different samples in a pooled bam by first estimating each sample's mixing fraction as the\naverage alt fraction in the bam of singleton hets belonging to that sample, then normalizing these initial estimates to\nsum to one.\nVersion:4.1.3.0\n",
        )
