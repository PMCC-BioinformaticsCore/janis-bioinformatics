...
class GatkMakeSitesOnlyVcfBase(Gatk4ToolBase, ABC):
    @classmethod
    def gatk_command(cls):
        return "MakeSitesOnlyVcf"

    def friendly_name(self) -> str:
        return "GATK4: MakeSitesOnlyVcf"

    def tool(self) -> str:
        return "Gatk4MakeSitesOnlyVcf"
        ...
        return [
            ToolInput(
                ...
                doc=InputDocumentation(
                    doc="(-I) Input VCF or BCF containing genotype and site-level information. Required."
                ),
            ),
            ToolInput(
                tag="outputFilename",
                ...
                separate_value_from_prefix=True,
                doc=InputDocumentation(
                    doc="(-O) Output VCF or BCF file containing only site-level information. Required."
                ),
            ),
            ToolInput(
                tag="arguments_file",
            ...
            ToolInput(
                ...
                separate_value_from_prefix=True,
                doc=InputDocumentation(
                    doc="(-S) Names of one or more samples to include in the output VCF. This argument may be specified 0 or more times. Default value: null. "
                ),
            ),
            ToolInput(
                tag="tmp_dir",
