...
class GatkEvaluateInfoFieldConcordanceBase(Gatk4ToolBase, ABC):
    @classmethod
    def gatk_command(cls):
        return "EvaluateInfoFieldConcordance"

    def friendly_name(self) -> str:
        return "GATK4: EvaluateInfoFieldConcordance"

    def tool(self) -> str:
        return "Gatk4EvaluateInfoFieldConcordance"
    ...
    def inputs(self):
        return [
            ToolInput(
                ...
                prefix="--eval-info-key",
                separate_value_from_prefix=True,
                doc=InputDocumentation(
                    doc="(-eval-info-key)  Info key from eval vcf  Required. "
                ),
            ),
            ToolInput(
                tag="evaluation",
                ...
                separate_value_from_prefix=True,
                doc=InputDocumentation(
                    doc="(-eval) A VCF containing variants to be compared to the truth Required."
                ),
            ),
            ToolInput(
                tag="summary",
                ...
                separate_value_from_prefix=True,
                doc=InputDocumentation(
                    doc="(-S) A table of summary statistics (true positives, sensitivity, etc.) Required."
                ),
            ),
            ToolInput(
                tag="truth",
                ...
                separate_value_from_prefix=True,
                doc=InputDocumentation(
                    doc="(-truth) A VCF containing truth variants Required."
                ),
            ),
            ToolInput(
                tag="truthInfoKey",
                input_type=String(optional=True),
                prefix="--truth-info-key",
                separate_value_from_prefix=True,
                doc=InputDocumentation(
                    doc="(-truth-info-key)  Info key from truth vcf  Required. "
                ),
            ),
            ToolInput(
            ...
            ToolInput(
                ...
                separate_value_from_prefix=True,
                doc=InputDocumentation(
                    doc="(-C) TO BE IMPLEMENTED Default value: null."
                ),
            ),
            ToolInput(
            ...
            ToolInput(
                ...
                separate_value_from_prefix=True,
                doc=InputDocumentation(
                    doc="(-epsilon) Difference tolerance Default value: 0.1."
                ),
            ),
            ToolInput(
                tag="showhidden",
            ...
            ToolInput(
                tag="warnBigDifferences",
                input_type=Boolean(optional=True),
                prefix="--warn-big-differences",
                separate_value_from_prefix=True,
                doc=InputDocumentation(
                    doc="(-warn-big-differences)  If set differences in the info key values greater than epsilon will trigger warnings.  Default value: false. Possible values: {true, false} "
                ),
            ),
            ToolInput(
    ...
    def metadata(self):
        return ToolMetadata(
            contributors=[],
            dateCreated=datetime.fromisoformat("2020-05-18T15:04:18.787455"),
            dateUpdated=datetime.fromisoformat("2020-05-18T15:04:18.787456"),
            documentation="**BETA FEATURE - WORK IN PROGRESS**\nUSAGE: EvaluateInfoFieldConcordance [arguments]\nThis tool evaluates info fields from an input VCF against a VCF that has been validated and is considered to represent\nground truth.\nVersion:4.1.3.0\n",
        )
