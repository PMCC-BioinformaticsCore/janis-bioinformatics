...
class GatkPostprocessGermlineCNVCallsBase(Gatk4ToolBase, ABC):
    @classmethod
    def gatk_command(cls):
        return "PostprocessGermlineCNVCalls"

    def friendly_name(self) -> str:
        return "GATK4: PostprocessGermlineCNVCalls"

    def tool(self) -> str:
        return "Gatk4PostprocessGermlineCNVCalls"
        ...
        return [
            ToolInput(
                ...
                doc=InputDocumentation(
                    doc="List of paths to GermlineCNVCaller call directories. This argument must be specified at least once. Required. "
                ),
            ),
            ToolInput(
                ...
                separate_value_from_prefix=True,
                doc=InputDocumentation(
                    doc="Path to contig-ploidy calls directory (output of DetermineGermlineContigPloidy). Required. "
                ),
            ),
            ToolInput(
                tag="modelShardPath",
                ...
                separate_value_from_prefix=True,
                doc=InputDocumentation(
                    doc="List of paths to GermlineCNVCaller model directories. This argument must be specified at least once. Required. "
                ),
            ),
            ToolInput(
                tag="outputDenoisedCopyRatios",
                input_type=File(optional=True),
                prefix="--output-denoised-copy-ratios",
                separate_value_from_prefix=True,
                doc=InputDocumentation(
                    doc=" Output denoised copy ratio file.  Required. "
                ),
            ),
            ToolInput(
                tag="outputGenotypedIntervals",
                input_type=File(optional=True),
                prefix="--output-genotyped-intervals",
                separate_value_from_prefix=True,
                doc=InputDocumentation(doc=" Output intervals VCF file.  Required. "),
            ),
            ToolInput(
                tag="outputGenotypedSegments",
                input_type=File(optional=True),
                prefix="--output-genotyped-segments",
                separate_value_from_prefix=True,
                doc=InputDocumentation(doc=" Output segments VCF file.  Required. "),
            ),
            ToolInput(
            ...
            ToolInput(
                ...
                separate_value_from_prefix=True,
                doc=InputDocumentation(
                    doc="Contigs to treat as allosomal (i.e. choose their reference copy-number allele according to the sample karyotype).  This argument may be specified 0 or more times. Default value: null. "
                ),
            ),
            ToolInput(
                tag="arguments_file",
            ...
            ToolInput(
                ...
                separate_value_from_prefix=True,
                doc=InputDocumentation(
                    doc="Sample index in the call-set (must be contained in all shards). Default value: 0."
                ),
            ),
            ToolInput(
    ...
    def metadata(self):
        return ToolMetadata(
            contributors=[],
            dateCreated=datetime.fromisoformat("2020-05-18T14:06:16.722506"),
            dateUpdated=datetime.fromisoformat("2020-05-18T14:06:16.722507"),
            documentation="USAGE: PostprocessGermlineCNVCalls [arguments]\nPostprocesses the output of GermlineCNVCaller and generates VCFs and denoised copy ratios\nVersion:4.1.3.0\n",
        )
