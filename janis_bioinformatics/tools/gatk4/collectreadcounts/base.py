...
class GatkCollectReadCountsBase(Gatk4ToolBase, ABC):
    @classmethod
    def gatk_command(cls):
        return "CollectReadCounts"

    def friendly_name(self) -> str:
        return "GATK4: CollectReadCounts"

    def tool(self) -> str:
        return "Gatk4CollectReadCounts"
    ...
    def inputs(self):
        return [
            ...
            ToolInput(
                ...
                separate_value_from_prefix=True,
                doc=InputDocumentation(
                    doc="(-O) Output file for read counts. Required."
                ),
            ),
            ToolInput(
            ...
            ToolInput(
                ...
                separate_value_from_prefix=True,
                doc=InputDocumentation(
                    doc="Output file format. Default value: HDF5. Possible values: {TSV, HDF5}"
                ),
            ),
            ToolInput(
                tag="gatkConfigFile",
    ...
    def metadata(self):
        return ToolMetadata(
            contributors=[],
            dateCreated=datetime.fromisoformat("2020-05-18T14:07:06.796085"),
            dateUpdated=datetime.fromisoformat("2020-05-18T14:07:06.796086"),
            documentation="USAGE: CollectReadCounts [arguments]\nCollects read counts at specified intervals\nVersion:4.1.3.0\n",
        )
