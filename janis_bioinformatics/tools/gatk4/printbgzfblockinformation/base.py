...
class GatkPrintBGZFBlockInformationBase(Gatk4ToolBase, ABC):
    @classmethod
    def gatk_command(cls):
        return "PrintBGZFBlockInformation"

    def friendly_name(self) -> str:
        return "GATK4: PrintBGZFBlockInformation"

    def tool(self) -> str:
        return "Gatk4PrintBGZFBlockInformation"
        ...
        return [
            ToolInput(
                ...
                doc=InputDocumentation(
                    doc="The BGZF-format file for which to print block information Required."
                ),
            ),
            ToolInput(
                tag="arguments_file",
            ...
            ToolInput(
                ...
                separate_value_from_prefix=True,
                doc=InputDocumentation(
                    doc="(-O) File to which to write block information (if not specified, prints to standard output) Default value: null. "
                ),
            ),
            ToolInput(
                tag="quiet",
    ...
    def metadata(self):
        return ToolMetadata(
            contributors=[],
            dateCreated=datetime.fromisoformat("2020-05-18T14:55:15.997960"),
            dateUpdated=datetime.fromisoformat("2020-05-18T14:55:15.997961"),
            documentation="**EXPERIMENTAL FEATURE - USE AT YOUR OWN RISK**\nUSAGE: PrintBGZFBlockInformation [arguments]\nPrint information about the compressed blocks in a BGZF format file\nVersion:4.1.3.0\n",
        )
