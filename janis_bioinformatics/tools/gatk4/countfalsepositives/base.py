...
class GatkCountFalsePositivesBase(Gatk4ToolBase, ABC):
    @classmethod
    def gatk_command(cls):
        return "CountFalsePositives"

    def friendly_name(self) -> str:
        return "GATK4: CountFalsePositives"

    def tool(self) -> str:
        return "Gatk4CountFalsePositives"
    ...
    def metadata(self):
        return ToolMetadata(
            contributors=[],
            dateCreated=datetime.fromisoformat("2020-05-18T15:03:56.287141"),
            dateUpdated=datetime.fromisoformat("2020-05-18T15:03:56.287142"),
            documentation="**BETA FEATURE - WORK IN PROGRESS**\nUSAGE: CountFalsePositives [arguments]\nCount PASS (false positive) variants in a vcf file for Mutect2 NA12878 normal-normal evaluation\nVersion:4.1.3.0\n",
        )
