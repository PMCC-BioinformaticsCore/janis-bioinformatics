...
class GatkSortSamSparkBase(Gatk4ToolBase, ABC):
    @classmethod
    def gatk_command(cls):
        return "SortSamSpark"

    def friendly_name(self) -> str:
        return "GATK4: SortSamSpark"

    def tool(self) -> str:
        return "Gatk4SortSamSpark"
    ...
    def inputs(self):
        return [
            ...
            ToolInput(
                ...
                prefix="--output",
                separate_value_from_prefix=True,
                doc=InputDocumentation(doc="(-O) the output file path Required."),
            ),
            ToolInput(
            ...
            ToolInput(
                ...
                separate_value_from_prefix=True,
                doc=InputDocumentation(
                    doc="(-SO)  sort order of the output file  Default value: coordinate. Possible values: {coordinate, queryname} "
                ),
            ),
            ToolInput(
                tag="sparkMaster",
    ...
    def metadata(self):
        return ToolMetadata(
            contributors=[],
            dateCreated=datetime.fromisoformat("2020-05-18T14:59:43.983833"),
            dateUpdated=datetime.fromisoformat("2020-05-18T14:59:43.983834"),
            documentation="**BETA FEATURE - WORK IN PROGRESS**\nUSAGE: SortSamSpark [arguments]\nSorts the input SAM/BAM/CRAM\nVersion:4.1.3.0\n",
        )
