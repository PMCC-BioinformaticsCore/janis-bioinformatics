...
class GatkCreateVerifyIDIntensityContaminationMetricsFileBase(Gatk4ToolBase, ABC):
    @classmethod
    def gatk_command(cls):
        return "CreateVerifyIDIntensityContaminationMetricsFile"

    def friendly_name(self) -> str:
        return "GATK4: CreateVerifyIDIntensityContaminationMetricsFile"

    def tool(self) -> str:
        return "Gatk4CreateVerifyIDIntensityContaminationMetricsFile"
        ...
        return [
            ToolInput(
                ...
                doc=InputDocumentation(
                    doc="(-I) The output of VerifyIDIntensity(typically captured stdout). Required."
                ),
            ),
            ToolInput(
                tag="outputFilename",
                ...
                separate_value_from_prefix=True,
                doc=InputDocumentation(
                    doc="(-O) Basename for the metrics file that will be written. Resulting file will be <OUTPUT>.verifyidintensity_metrics  Required. "
                ),
            ),
            ToolInput(
                tag="arguments_file",
