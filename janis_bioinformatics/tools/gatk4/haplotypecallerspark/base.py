...
class GatkHaplotypeCallerSparkBase(Gatk4ToolBase, ABC):
    @classmethod
    def gatk_command(cls):
        return "HaplotypeCallerSpark"

    def friendly_name(self) -> str:
        return "GATK4: HaplotypeCallerSpark"

    def tool(self) -> str:
        return "Gatk4HaplotypeCallerSpark"
    ...
    def inputs(self):
        return [
            ...
            ToolInput(
                ...
                separate_value_from_prefix=True,
                doc=InputDocumentation(
                    doc="(-O) Single file to which variants should be written Required."
                ),
            ),
            ToolInput(
                tag="reference",
    ...
    def metadata(self):
        return ToolMetadata(
            contributors=[],
            dateCreated=datetime.fromisoformat("2020-05-18T15:02:06.091322"),
            dateUpdated=datetime.fromisoformat("2020-05-18T15:02:06.091323"),
            documentation="**BETA FEATURE - WORK IN PROGRESS**\nUSAGE: HaplotypeCallerSpark [arguments]\nHaplotypeCaller on Spark\nVersion:4.1.3.0\n",
        )
