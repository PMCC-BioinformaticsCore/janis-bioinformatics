...
class GatkFastaReferenceMakerBase(Gatk4ToolBase, ABC):
    @classmethod
    def gatk_command(cls):
        return "FastaReferenceMaker"

    def friendly_name(self) -> str:
        return "GATK4: FastaReferenceMaker"

    def tool(self) -> str:
        return "Gatk4FastaReferenceMaker"
    ...
    def metadata(self):
        return ToolMetadata(
            contributors=[],
            dateCreated=datetime.fromisoformat("2020-05-18T15:01:03.390172"),
            dateUpdated=datetime.fromisoformat("2020-05-18T15:01:03.390174"),
            documentation="USAGE: FastaReferenceMaker [arguments]\nCreate snippets of a fasta file by subsetting to an interval list\nVersion:4.1.3.0\n",
        )
