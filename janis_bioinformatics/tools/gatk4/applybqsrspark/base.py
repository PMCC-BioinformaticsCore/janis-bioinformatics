...
class GatkApplyBQSRSparkBase(Gatk4ToolBase, ABC):
    @classmethod
    def gatk_command(cls):
        return "ApplyBQSRSpark"

    def friendly_name(self) -> str:
        return "GATK4: ApplyBQSRSpark"

    def tool(self) -> str:
        return "Gatk4ApplyBQSRSpark"
    ...
    def inputs(self):
        return [
            ToolInput(
                ...
                doc=InputDocumentation(doc="(-bqsr) Required."),
            ),
            ToolInput(
                tag="inp",
    ...
    def metadata(self):
        return ToolMetadata(
            contributors=[],
            dateCreated=datetime.fromisoformat("2020-05-18T14:55:41.053175"),
            dateUpdated=datetime.fromisoformat("2020-05-18T14:55:41.053176"),
            documentation="**BETA FEATURE - WORK IN PROGRESS**\nUSAGE: ApplyBQSRSpark [arguments]\nApply a linear base quality recalibration model trained with the BaseRecalibrator tool on Spark.\nVersion:4.1.3.0\n",
        )
