...
class GatkSplitIntervalsBase(Gatk4ToolBase, ABC):
    @classmethod
    def gatk_command(cls):
        return "SplitIntervals"

    def friendly_name(self) -> str:
        return "GATK4: SplitIntervals"

    def tool(self) -> str:
        return "Gatk4SplitIntervals"
        ...
        return [
            ToolInput(
                ...
                doc=InputDocumentation(
                    doc="(-O) The directory into which to write the scattered interval sub-directories. Required."
                ),
            ),
            ToolInput(
            ...
            ToolInput(
                ...
                separate_value_from_prefix=True,
                doc=InputDocumentation(
                    doc="Extension to use when writing interval files Default value: -scattered.interval_list."
                ),
            ),
            ToolInput(
                tag="gatkConfigFile",
            ...
            ToolInput(
                ...
                separate_value_from_prefix=True,
                doc=InputDocumentation(
                    doc="Minimum contig size to keep if getting intervals from the reference Default value: 0."
                ),
            ),
            ToolInput(
                tag="quiet",
            ...
            ToolInput(
                ...
                separate_value_from_prefix=True,
                doc=InputDocumentation(
                    doc="(-scatter)  scatter count: number of output interval files to split into  Default value: 1. "
                ),
            ),
            ToolInput(
    ...
    def metadata(self):
        return ToolMetadata(
            contributors=[],
            dateCreated=datetime.fromisoformat("2020-05-18T14:53:56.380168"),
            dateUpdated=datetime.fromisoformat("2020-05-18T14:53:56.380169"),
            documentation="USAGE: SplitIntervals [arguments]\nSplit intervals into sub-interval files.\nVersion:4.1.3.0\n",
        )
