...
class GatkAddOATagBase(Gatk4ToolBase, ABC):
    @classmethod
    def gatk_command(cls):
        return "AddOATag"

    def friendly_name(self) -> str:
        return "GATK4: AddOATag"

    def tool(self) -> str:
        return "Gatk4AddOATag"
    ...
    def inputs(self):
        return [
            ToolInput(
                ...
                doc=InputDocumentation(doc="(-I) SAM or BAM input file Required."),
            ),
            ToolInput(
                tag="outputFilename",
                ...
                doc=InputDocumentation(
                    doc="(-O) SAM or BAM file to write merged result to Required."
                ),
            ),
            ToolInput(
                tag="arguments_file",
            ...
            ToolInput(
                ...
                separate_value_from_prefix=True,
                doc=InputDocumentation(
                    doc="(-L) If provided, only records that overlap given interval list will have the OA tag added. Default value: null. "
                ),
            ),
            ToolInput(
