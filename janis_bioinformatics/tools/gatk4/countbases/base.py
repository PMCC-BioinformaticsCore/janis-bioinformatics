...
class GatkCountBasesBase(Gatk4ToolBase, ABC):
    @classmethod
    def gatk_command(cls):
        return "CountBases"

    def friendly_name(self) -> str:
        return "GATK4: CountBases"

    def tool(self) -> str:
        return "Gatk4CountBases"
    ...
    def metadata(self):
        return ToolMetadata(
            contributors=[],
            dateCreated=datetime.fromisoformat("2020-05-18T14:07:13.444511"),
            dateUpdated=datetime.fromisoformat("2020-05-18T14:07:13.444512"),
            documentation="USAGE: CountBases [arguments]\nCounts bases in a SAM/BAM/CRAM file\nVersion:4.1.3.0\n",
        )
