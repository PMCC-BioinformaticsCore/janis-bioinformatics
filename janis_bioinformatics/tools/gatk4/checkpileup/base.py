...
class GatkCheckPileupBase(Gatk4ToolBase, ABC):
    @classmethod
    def gatk_command(cls):
        return "CheckPileup"

    def friendly_name(self) -> str:
        return "GATK4: CheckPileup"

    def tool(self) -> str:
        return "Gatk4CheckPileup"
    ...
    def inputs(self):
        return [
            ...
            ToolInput(
                ...
                prefix="--pileup",
                separate_value_from_prefix=True,
                doc=InputDocumentation(doc="Pileup generated by Samtools Required."),
            ),
            ToolInput(
                tag="reference",
                input_type=String(optional=True),
            ...
            ToolInput(
                ...
                separate_value_from_prefix=True,
                doc=InputDocumentation(
                    doc="Disable read-pair overlap detection Default value: false. Possible values: {true, false}"
                ),
            ),
            ToolInput(
