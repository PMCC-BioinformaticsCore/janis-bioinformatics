...
class GatkCalculateGenotypePosteriorsBase(Gatk4ToolBase, ABC):
    @classmethod
    def gatk_command(cls):
        return "CalculateGenotypePosteriors"

    def friendly_name(self) -> str:
        return "GATK4: CalculateGenotypePosteriors"

    def tool(self) -> str:
        return "Gatk4CalculateGenotypePosteriors"
    ...
    def inputs(self):
        return [
            ...
            ToolInput(
                tag="discoveredAlleleCountPriorsOff",
                input_type=Boolean(optional=True),
                prefix="--discovered-allele-count-priors-off",
                separate_value_from_prefix=True,
                doc=InputDocumentation(
                    doc=" Do not use discovered allele count in the input callset for variants that do not appear in the external callset.   Default value: false. Possible values: {true, false} "
                ),
            ),
            ToolInput(
            ...
            ToolInput(
                tag="globalPriorIndel",
                input_type=Double(optional=True),
                prefix="--global-prior-indel",
                separate_value_from_prefix=True,
                doc=InputDocumentation(
                    doc="Global Dirichlet prior parameters for the indel allele frequency Default value: 0.001."
                ),
            ),
            ToolInput(
                tag="globalPriorSnp",
                ...
                separate_value_from_prefix=True,
                doc=InputDocumentation(
                    doc="Global Dirichlet prior parameters for the SNP allele frequency Default value: 0.001."
                ),
            ),
            ToolInput(
                tag="help",
            ...
            ToolInput(
                ...
                separate_value_from_prefix=True,
                doc=InputDocumentation(
                    doc="(-ped) Pedigree file for samples Default value: null."
                ),
            ),
            ToolInput(
                tag="quiet",
            ...
            ToolInput(
                tag="skipFamilyPriors",
                input_type=Boolean(optional=True),
                prefix="--skip-family-priors",
                separate_value_from_prefix=True,
                doc=InputDocumentation(
                    doc="Skip application of family-based priors Default value: false. Possible values: {true, false} "
                ),
            ),
            ToolInput(
                tag="skipPopulationPriors",
                input_type=Boolean(optional=True),
                prefix="--skip-population-priors",
                separate_value_from_prefix=True,
                doc=InputDocumentation(
                    doc=" Skip application of population-based priors  Default value: false. Possible values: {true, false} "
                ),
            ),
            ToolInput(
                tag="supportingCallsets",
                input_type=Boolean(optional=True),
                prefix="--supporting-callsets",
                separate_value_from_prefix=True,
                doc=InputDocumentation(
                    doc="(-supporting)  Other callsets to use in generating genotype posteriors  This argument may be specified 0 or more times. Default value: null. "
                ),
            ),
            ToolInput(
                tag="tmpDir",
            ...
            ToolInput(
                tag="useFlatPriorsForIndels",
                input_type=Boolean(optional=True),
                prefix="--use-flat-priors-for-indels",
                separate_value_from_prefix=True,
                doc=InputDocumentation(
                    doc="(-skipIndels)  Use flat priors for indels  Default value: false. Possible values: {true, false} "
                ),
            ),
            ToolInput(
                tag="useJdkDeflater",
