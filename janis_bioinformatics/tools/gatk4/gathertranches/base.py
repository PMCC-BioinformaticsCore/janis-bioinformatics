...
class GatkGatherTranchesBase(Gatk4ToolBase, ABC):
    @classmethod
    def gatk_command(cls):
        return "GatherTranches"

    def friendly_name(self) -> str:
        return "GATK4: GatherTranches"

    def tool(self) -> str:
        return "Gatk4GatherTranches"
        ...
        return [
            ToolInput(
                ...
                doc=InputDocumentation(
                    doc="(-I) List of scattered tranches files This argument must be specified at least once. Required."
                ),
            ),
            ToolInput(
                tag="outputFilename",
                ...
                separate_value_from_prefix=True,
                doc=InputDocumentation(
                    doc="(-O) File to output the gathered tranches file to Required."
                ),
            ),
            ToolInput(
                tag="arguments_file",
    ...
    def metadata(self):
        return ToolMetadata(
            contributors=[],
            dateCreated=datetime.fromisoformat("2020-05-18T14:54:58.332667"),
            dateUpdated=datetime.fromisoformat("2020-05-18T14:54:58.332667"),
            documentation="**BETA FEATURE - WORK IN PROGRESS**\nUSAGE: GatherTranches [arguments]\nGathers scattered VQSLOD tranches into a single file. For use when running VariantRecalibrator on scattered input using\nthe -scatterTranches mode.\nVersion:4.1.3.0\n",
        )
