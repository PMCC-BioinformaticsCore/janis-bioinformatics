...
class GatkCountBasesInReferenceBase(Gatk4ToolBase, ABC):
    @classmethod
    def gatk_command(cls):
        return "CountBasesInReference"

    def friendly_name(self) -> str:
        return "GATK4: CountBasesInReference"

    def tool(self) -> str:
        return "Gatk4CountBasesInReference"
    ...
    def metadata(self):
        return ToolMetadata(
            contributors=[],
            dateCreated=datetime.fromisoformat("2020-05-18T15:00:43.488178"),
            dateUpdated=datetime.fromisoformat("2020-05-18T15:00:43.488179"),
            documentation="USAGE: CountBasesInReference [arguments]\nCount the number of times each individual base occurs in a reference file.\nVersion:4.1.3.0\n",
        )
