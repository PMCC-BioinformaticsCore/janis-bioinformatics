...
class GatkCollectBaseDistributionByCycleSparkBase(Gatk4ToolBase, ABC):
    @classmethod
    def gatk_command(cls):
        return "CollectBaseDistributionByCycleSpark"

    def friendly_name(self) -> str:
        return "GATK4: CollectBaseDistributionByCycleSpark"

    def tool(self) -> str:
        return "Gatk4CollectBaseDistributionByCycleSpark"
    ...
    def inputs(self):
        return [
            ...
            ToolInput(
                tag="alignedReadsOnly",
                input_type=Boolean(optional=True),
                prefix="--aligned-reads-only",
                separate_value_from_prefix=True,
                doc=InputDocumentation(
                    doc="(-A)  If set to true, calculates the base distribution over aligned reads only.  Default value: false. Possible values: {true, false} "
                ),
            ),
            ToolInput(
                tag="arguments_file",
            ...
            ToolInput(
                ...
                separate_value_from_prefix=True,
                doc=InputDocumentation(
                    doc="(-C) Output charts file (pdf). Default value: null."
                ),
            ),
            ToolInput(
                tag="conf",
            ...
            ToolInput(
                ...
                separate_value_from_prefix=True,
                doc=InputDocumentation(
                    doc="(-O) Output metrics file. Default value: null."
                ),
            ),
            ToolInput(
            ...
            ToolInput(
                ...
                separate_value_from_prefix=True,
                doc=InputDocumentation(
                    doc="(-F) If set to true, calculates the base distribution over passing filter (PF) reads only. Default value: false. Possible values: {true, false} "
                ),
            ),
            ToolInput(
                tag="programName",
    ...
    def metadata(self):
        return ToolMetadata(
            contributors=[],
            dateCreated=datetime.fromisoformat("2020-05-19T08:37:42.530824"),
            dateUpdated=datetime.fromisoformat("2020-05-19T08:37:42.530825"),
            documentation="**BETA FEATURE - WORK IN PROGRESS**\nUSAGE: CollectBaseDistributionByCycleSpark [arguments]\nCollects base distribution per cycle in SAM/BAM/CRAM file(s). The tool leverages the Spark framework for faster\noperation.\nVersion:4.1.3.0\n",
        )
