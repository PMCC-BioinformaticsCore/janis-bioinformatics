...
class GatkFastaAlternateReferenceMakerBase(Gatk4ToolBase, ABC):
    @classmethod
    def gatk_command(cls):
        return "FastaAlternateReferenceMaker"

    def friendly_name(self) -> str:
        return "GATK4: FastaAlternateReferenceMaker"

    def tool(self) -> str:
        return "Gatk4FastaAlternateReferenceMaker"
        ...
        return [
            ToolInput(
                ...
                doc=InputDocumentation(
                    doc="(-O) Path to write the output fasta to Required."
                ),
            ),
            ToolInput(
                tag="reference",
            ...
            ToolInput(
                ...
                separate_value_from_prefix=True,
                doc=InputDocumentation(
                    doc="(-V) A source of variants to merge with the reference sequence. Required."
                ),
            ),
            ToolInput(
            ...
            ToolInput(
                ...
                separate_value_from_prefix=True,
                doc=InputDocumentation(
                    doc="Maximum length of sequence to write per line Default value: 60."
                ),
            ),
            ToolInput(
                tag="quiet",
            ...
            ToolInput(
                ...
                prefix="--snp-mask",
                separate_value_from_prefix=True,
                doc=InputDocumentation(doc="SNP mask VCF file Default value: null."),
            ),
            ToolInput(
                tag="snpMaskPriority",
                input_type=Boolean(optional=True),
                prefix="--snp-mask-priority",
                separate_value_from_prefix=True,
                doc=InputDocumentation(
                    doc="Give the snp mask priority over the input VCF. Default value: false. Possible values: {true, false} "
                ),
            ),
            ToolInput(
                tag="tmpDir",
            ...
            ToolInput(
                tag="useIupacSample",
                input_type=String(optional=True),
                prefix="--use-iupac-sample",
                separate_value_from_prefix=True,
                doc=InputDocumentation(
                    doc="If specified, heterozygous SNP sites will be output using IUPAC ambiguity codes given the genotypes for this sample  Default value: null. "
                ),
            ),
            ToolInput(
                tag="useJdkDeflater",
    ...
    def metadata(self):
        return ToolMetadata(
            contributors=[],
            dateCreated=datetime.fromisoformat("2020-05-18T15:00:56.588447"),
            dateUpdated=datetime.fromisoformat("2020-05-18T15:00:56.588448"),
            documentation="USAGE: FastaAlternateReferenceMaker [arguments]\nCreate an alternative fasta reference by inserting variants from a vcf into an existing reference sequence.\nVersion:4.1.3.0\n",
        )
