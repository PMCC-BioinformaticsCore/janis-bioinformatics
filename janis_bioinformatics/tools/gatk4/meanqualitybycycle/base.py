...
class GatkMeanQualityByCycleBase(Gatk4ToolBase, ABC):
    @classmethod
    def gatk_command(cls):
        return "MeanQualityByCycle"

    def friendly_name(self) -> str:
        return "GATK4: MeanQualityByCycle"

    def tool(self) -> str:
        return "Gatk4MeanQualityByCycle"
