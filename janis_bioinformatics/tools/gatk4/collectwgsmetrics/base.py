...
class GatkCollectWgsMetricsBase(Gatk4ToolBase, ABC):
    @classmethod
    def gatk_command(cls):
        return "CollectWgsMetrics"

    def friendly_name(self) -> str:
        return "GATK4: CollectWgsMetrics"

    def tool(self) -> str:
        return "Gatk4CollectWgsMetrics"
