...
class GatkConvertHeaderlessHadoopBamShardToBamBase(Gatk4ToolBase, ABC):
    @classmethod
    def gatk_command(cls):
        return "ConvertHeaderlessHadoopBamShardToBam"

    def friendly_name(self) -> str:
        return "GATK4: ConvertHeaderlessHadoopBamShardToBam"

    def tool(self) -> str:
        return "Gatk4ConvertHeaderlessHadoopBamShardToBam"
    ...
    def inputs(self):
        return [
            ...
            ToolInput(
                ...
                separate_value_from_prefix=True,
                doc=InputDocumentation(
                    doc="(-O) Location to write the converted BAM shard Required."
                ),
            ),
            ToolInput(
                tag="arguments_file",
    ...
    def metadata(self):
        return ToolMetadata(
            contributors=[],
            dateCreated=datetime.fromisoformat("2020-05-18T14:56:40.579734"),
            dateUpdated=datetime.fromisoformat("2020-05-18T14:56:40.579735"),
            documentation="**BETA FEATURE - WORK IN PROGRESS**\nUSAGE: ConvertHeaderlessHadoopBamShardToBam [arguments]\nThis is a troubleshooting utility that converts a headerless BAM shard (e.g., a part-r-00000.bam, part-r-00001.bam,\netc.), produced by a Spark tool with --sharded-output set to true, into a readable BAM file by adding a header and a\nBGZF terminator.\nVersion:4.1.3.0\n",
        )
