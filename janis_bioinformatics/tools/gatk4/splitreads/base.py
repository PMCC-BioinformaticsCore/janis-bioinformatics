...
class GatkSplitReadsBase(Gatk4ToolBase, ABC):
    @classmethod
    ...
    def inputs(self):
        return [
            ...
            ToolInput(
                ...
                separate_value_from_prefix=True,
                doc=InputDocumentation(
                    doc="(-O) The directory to output SAM/BAM/CRAM files. Default value: ."
                ),
            ),
            ToolInput(
                tag="quiet",
            ...
            ToolInput(
                ...
                separate_value_from_prefix=True,
                doc=InputDocumentation(
                    doc="(-RG) Default value: false. Possible values: {true, false}"
                ),
            ),
            ToolInput(
                tag="splitSample",
                ...
                separate_value_from_prefix=True,
                doc=InputDocumentation(
                    doc="(-SM) Split file by sample. Default value: false. Possible values: {true, false}"
                ),
            ),
            ToolInput(
                tag="tmpDir",
    ...
    def metadata(self):
        return ToolMetadata(
            contributors=[],
            dateCreated=datetime.fromisoformat("2020-05-18T14:59:57.647332"),
            dateUpdated=datetime.fromisoformat("2020-05-18T14:59:57.647334"),
