...
class GatkMergeAnnotatedRegionsBase(Gatk4ToolBase, ABC):
    @classmethod
    def gatk_command(cls):
        return "MergeAnnotatedRegions"

    def friendly_name(self) -> str:
        return "GATK4: MergeAnnotatedRegions"

    def tool(self) -> str:
        return "Gatk4MergeAnnotatedRegions"
        ...
        return [
            ...
            ToolInput(
                ...
                doc=InputDocumentation(
                    doc="Input segment file or annotated segment file -- touching segments will be merged in the output.  Required. "
                ),
            ),
            ToolInput(
    ...
    def metadata(self):
        return ToolMetadata(
            contributors=[],
            dateCreated=datetime.fromisoformat("2020-05-18T14:05:44.924968"),
            dateUpdated=datetime.fromisoformat("2020-05-18T14:05:44.924970"),
            documentation="**EXPERIMENTAL FEATURE - USE AT YOUR OWN RISK**\nUSAGE: MergeAnnotatedRegions [arguments]\nMerge annotated genomic regions based entirely on contig and annotation value.  Column header order is not guaranteed to\nbe preserved. Reference is required and will superseded any sequence dictionary in the given seg/region files.  Sequence\ndictionary is optional on the input file, but will be included on the output.  Conflicts of annotations is resolved by\nsorting the values and inserting a delimiter.  THIS TOOL IS TOTALLY UNSUPPORTED\nVersion:4.1.3.0\n",
        )
