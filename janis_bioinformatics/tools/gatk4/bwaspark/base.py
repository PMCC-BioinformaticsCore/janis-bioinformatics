...
class GatkBwaSparkBase(Gatk4ToolBase, ABC):
    @classmethod
    def gatk_command(cls):
        return "BwaSpark"

    def friendly_name(self) -> str:
        return "GATK4: BwaSpark"

    def tool(self) -> str:
        return "Gatk4BwaSpark"
    ...
    def inputs(self):
        return [
            ...
            ToolInput(
                ...
                separate_value_from_prefix=True,
                doc=InputDocumentation(
                    doc="(-DF)  Read filters to be disabled before analysis  This argument may be specified 0 or more times. Default value: null. Possible Values: {PrimaryLineReadFilter, SeqIsStoredReadFilter}"
                ),
            ),
            ToolInput(
    ...
    def metadata(self):
        return ToolMetadata(
            contributors=[],
            dateCreated=datetime.fromisoformat("2020-05-18T14:56:20.257289"),
            dateUpdated=datetime.fromisoformat("2020-05-18T14:56:20.257290"),
            documentation="**BETA FEATURE - WORK IN PROGRESS**\nUSAGE: BwaSpark [arguments]\nAlign reads using BWA\nVersion:4.1.3.0\n",
        )
