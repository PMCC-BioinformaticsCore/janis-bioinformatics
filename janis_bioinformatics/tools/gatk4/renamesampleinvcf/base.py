...
class GatkRenameSampleInVcfBase(Gatk4ToolBase, ABC):
    @classmethod
    def gatk_command(cls):
        return "RenameSampleInVcf"

    def friendly_name(self) -> str:
        return "GATK4: RenameSampleInVcf"

    def tool(self) -> str:
        return "Gatk4RenameSampleInVcf"
        ...
        return [
            ToolInput(
                ...
                doc=InputDocumentation(
                    doc="(-I) Input single sample VCF or BCF file. Required."
                ),
            ),
            ToolInput(
                tag="new_sample_name",
            ...
            ToolInput(
                ...
                prefix="--OUTPUT",
                separate_value_from_prefix=True,
                doc=InputDocumentation(doc="(-O) Output single sample VCF. Required."),
            ),
            ToolInput(
                tag="arguments_file",
                input_type=File(optional=True),
            ...
            ToolInput(
                ...
                separate_value_from_prefix=True,
                doc=InputDocumentation(
                    doc="Existing name of sample in VCF; if provided, asserts that that is the name of the extant sample name  Default value: null. "
                ),
            ),
            ToolInput(
                tag="quiet",
