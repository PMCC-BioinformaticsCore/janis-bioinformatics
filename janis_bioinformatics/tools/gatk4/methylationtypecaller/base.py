...
class GatkMethylationTypeCallerBase(Gatk4ToolBase, ABC):
    @classmethod
    def gatk_command(cls):
        return "MethylationTypeCaller"

    def friendly_name(self) -> str:
        return "GATK4: MethylationTypeCaller"

    def tool(self) -> str:
        return "Gatk4MethylationTypeCaller"
    ...
    def inputs(self):
        return [
            ...
            ToolInput(
                ...
                separate_value_from_prefix=True,
                doc=InputDocumentation(
                    doc="(-DF)  Read filters to be disabled before analysis  This argument may be specified 0 or more times. Default value: null. Possible Values: {MappedReadFilter, WellformedReadFilter}"
                ),
            ),
            ToolInput(
    ...
    def metadata(self):
        return ToolMetadata(
            contributors=[],
            dateCreated=datetime.fromisoformat("2020-05-18T14:54:37.861289"),
            dateUpdated=datetime.fromisoformat("2020-05-18T14:54:37.861290"),
            documentation="**EXPERIMENTAL FEATURE - USE AT YOUR OWN RISK**\nUSAGE: MethylationTypeCaller [arguments]\nTool that prints methylation-based coverage from supplied bisulfite sequenced, methylation-aware aligned BAM to the\nspecified output vcf file\nVersion:4.1.3.0\n",
        )
