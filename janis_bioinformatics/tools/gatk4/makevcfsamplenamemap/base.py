...
class GatkMakeVcfSampleNameMapBase(Gatk4ToolBase, ABC):
    @classmethod
    def gatk_command(cls):
        return "MakeVcfSampleNameMap"

    def friendly_name(self) -> str:
        return "GATK4: MakeVcfSampleNameMap"

    def tool(self) -> str:
        return "Gatk4MakeVcfSampleNameMap"
        ...
        return [
            ToolInput(
                ...
                doc=InputDocumentation(
                    doc="(-I) One or more input VCFs to extract sample names from. This argument must be specified at least once. Required. "
                ),
            ),
            ToolInput(
                tag="outputFilename",
                ...
                separate_value_from_prefix=True,
                doc=InputDocumentation(
                    doc="(-O) Output file to write the sample-name map to. Required."
                ),
            ),
            ToolInput(
                tag="arguments_file",
