...
class GatkSamFormatConverterBase(Gatk4ToolBase, ABC):
    @classmethod
    def gatk_command(cls):
        return "SamFormatConverter"

    def friendly_name(self) -> str:
        return "GATK4: SamFormatConverter"

    def tool(self) -> str:
        return "Gatk4SamFormatConverter"
        ...
        return [
            ToolInput(
                ...
                doc=InputDocumentation(
                    doc="(-I) The BAM or SAM file to parse. Required."
                ),
            ),
            ToolInput(
                tag="outputFilename",
                ...
                separate_value_from_prefix=True,
                doc=InputDocumentation(
                    doc="(-O) The BAM or SAM output file. Required."
                ),
            ),
            ToolInput(
                tag="arguments_file",
    ...
    def metadata(self):
        return ToolMetadata(
            contributors=[],
            dateCreated=datetime.fromisoformat("2020-05-18T14:59:04.286936"),
            dateUpdated=datetime.fromisoformat("2020-05-18T14:59:04.286942"),
            documentation="b'USAGE: SamFormatConverter [arguments]\nConvert a BAM file to a SAM file, or SAM to BAM.\nInput and output formats are determined by file extension.\nVersion:4.1.3.0\n",
        )
