...
class GatkQualityScoreDistributionSparkBase(Gatk4ToolBase, ABC):
    @classmethod
    def gatk_command(cls):
        return "QualityScoreDistributionSpark"

    def friendly_name(self) -> str:
        return "GATK4: QualityScoreDistributionSpark"

    def tool(self) -> str:
        return "Gatk4QualityScoreDistributionSpark"
    ...
    def inputs(self):
        return [
            ...
            ToolInput(
                ...
                separate_value_from_prefix=True,
                doc=InputDocumentation(
                    doc="(-A) Default value: false. Possible values: {true, false} "
                ),
            ),
            ToolInput(
                tag="arguments_file",
            ...
            ToolInput(
                ...
                separate_value_from_prefix=True,
                doc=InputDocumentation(
                    doc="(-C) A file (with .pdf extension) to write the chart to. Default value: null."
                ),
            ),
            ToolInput(
                tag="conf",
            ...
            ToolInput(
                ...
                separate_value_from_prefix=True,
                doc=InputDocumentation(
                    doc="(-NC) If set to true, include quality for no-call bases in the distribution. Default value: false. Possible values: {true, false} "
                ),
            ),
            ToolInput(
                tag="inp",
            ...
            ToolInput(
                ...
                separate_value_from_prefix=True,
                doc=InputDocumentation(
                    doc="(-F) If set to true calculate mean quality over PF reads only. Default value: false. Possible values: {true, false} "
                ),
            ),
            ToolInput(
                tag="programName",
    ...
    def metadata(self):
        return ToolMetadata(
            contributors=[],
            dateCreated=datetime.fromisoformat("2020-05-19T08:38:04.594802"),
            dateUpdated=datetime.fromisoformat("2020-05-19T08:38:04.594803"),
            documentation="**BETA FEATURE - WORK IN PROGRESS**\nUSAGE: QualityScoreDistributionSpark [arguments]\nProgram to chart quality score distributions in a SAM/BAM file.\nVersion:4.1.3.0\n",
        )
