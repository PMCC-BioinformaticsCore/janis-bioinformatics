...
class GatkPrintVariantsSparkBase(Gatk4ToolBase, ABC):
    @classmethod
    def gatk_command(cls):
        return "PrintVariantsSpark"

    def friendly_name(self) -> str:
        return "GATK4: PrintVariantsSpark"

    def tool(self) -> str:
        return "Gatk4PrintVariantsSpark"
        ...
        return [
            ToolInput(
                ...
                doc=InputDocumentation(
                    doc="(-O) Uri for the output file (a local file path). Required."
                ),
            ),
            ToolInput(
                tag="variant",
            ...
            ToolInput(
                ...
                separate_value_from_prefix=True,
                doc=InputDocumentation(
                    doc="(-shuffle) whether to use the shuffle implementation or not Default value: false. Possible values: {true, false} "
                ),
            ),
            ToolInput(
                tag="sparkMaster",
            ...
            ToolInput(
                tag="variantshardsize",
                input_type=Int(optional=True),
                prefix="--variantShardSize",
                separate_value_from_prefix=True,
                doc=InputDocumentation(
                    doc="(-variantShardSize)  Maximum size of each variant shard, in bases.  Default value: 10000. "
                ),
            ),
            ToolInput(
                tag="verbosity",
    ...
    def metadata(self):
        return ToolMetadata(
            contributors=[],
            dateCreated=datetime.fromisoformat("2020-05-18T15:07:39.836144"),
            dateUpdated=datetime.fromisoformat("2020-05-18T15:07:39.836145"),
            documentation="USAGE: PrintVariantsSpark [arguments]\nPrints out variants from the input VCF file.\nVersion:4.1.3.0\n",
        )
