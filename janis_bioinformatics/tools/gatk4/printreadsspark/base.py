...
class GatkPrintReadsSparkBase(Gatk4ToolBase, ABC):
    @classmethod
    def gatk_command(cls):
        return "PrintReadsSpark"

    def friendly_name(self) -> str:
        return "GATK4: PrintReadsSpark"

    def tool(self) -> str:
        return "Gatk4PrintReadsSpark"
    ...
    def metadata(self):
        return ToolMetadata(
            contributors=[],
            dateCreated=datetime.fromisoformat("2020-05-18T14:58:23.103088"),
            dateUpdated=datetime.fromisoformat("2020-05-18T14:58:23.103089"),
            documentation="USAGE: PrintReadsSpark [arguments]\nPrint reads from the input BAM\nVersion:4.1.3.0\n",
        )
