...
class GatkSplitVcfsBase(Gatk4ToolBase, ABC):
    @classmethod
    def gatk_command(cls):
        return "SplitVcfs"

    def friendly_name(self) -> str:
        return "GATK4: SplitVcfs"

    def tool(self) -> str:
        return "Gatk4SplitVcfs"
        ...
        return [
            ToolInput(
                ...
                doc=InputDocumentation(
                    doc="The VCF or BCF file to which indel records should be written. The file format is determined by file extension.  Required. "
                ),
            ),
            ToolInput(
                tag="inp",
                ...
                prefix="--INPUT",
                separate_value_from_prefix=True,
                doc=InputDocumentation(doc="(-I) The VCF or BCF input file Required."),
            ),
            ToolInput(
                tag="snp_output",
                input_type=File(optional=True),
                ...
                separate_value_from_prefix=True,
                doc=InputDocumentation(
                    doc="The VCF or BCF file to which SNP records should be written. The file format is determined by file extension.  Required. "
                ),
            ),
            ToolInput(
                tag="arguments_file",
            ...
            ToolInput(
                ...
                separate_value_from_prefix=True,
                doc=InputDocumentation(doc="(-D)  files  Default value: null. "),
            ),
            ToolInput(
                tag="strict",
                input_type=Boolean(optional=True),
                ...
                separate_value_from_prefix=True,
                doc=InputDocumentation(
                    doc="If true an exception will be thrown if an event type other than SNP or indel is encountered  Default value: true. Possible values: {true, false} "
                ),
            ),
            ToolInput(
                tag="tmp_dir",
