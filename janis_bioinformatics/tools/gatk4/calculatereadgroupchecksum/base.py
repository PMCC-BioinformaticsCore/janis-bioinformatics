...
class GatkCalculateReadGroupChecksumBase(Gatk4ToolBase, ABC):
    @classmethod
    def gatk_command(cls):
        return "CalculateReadGroupChecksum"

    def friendly_name(self) -> str:
        return "GATK4: CalculateReadGroupChecksum"

    def tool(self) -> str:
        return "Gatk4CalculateReadGroupChecksum"
    ...
    def inputs(self):
        return [
            ToolInput(
                ...
                doc=InputDocumentation(doc="(-I) The input SAM or BAM file. Required."),
            ),
            ToolInput(
                tag="arguments_file",
                input_type=File(optional=True),
            ...
            ToolInput(
                ...
                separate_value_from_prefix=True,
                doc=InputDocumentation(
                    doc="(-O) The file to which the hash code should be written. Default value: null."
                ),
            ),
            ToolInput(
                tag="quiet",
