...
class GatkVcfToIntervalListBase(Gatk4ToolBase, ABC):
    @classmethod
    def gatk_command(cls):
        return "VcfToIntervalList"

    def friendly_name(self) -> str:
        return "GATK4: VcfToIntervalList"

    def tool(self) -> str:
        return "Gatk4VcfToIntervalList"
        ...
        return [
            ToolInput(
                ...
                doc=InputDocumentation(
                    doc="(-I) The BCF or VCF input file. The file format is determined by file extension. Required."
                ),
            ),
            ToolInput(
                tag="outputFilename",
            ...
            ToolInput(
                ...
                separate_value_from_prefix=True,
                doc=InputDocumentation(
                    doc="(-IF) Default value: false. Possible values: {true, false} "
                ),
            ),
            ToolInput(
