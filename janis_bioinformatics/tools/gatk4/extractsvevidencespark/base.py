...
class GatkExtractSVEvidenceSparkBase(Gatk4ToolBase, ABC):
    @classmethod
    def gatk_command(cls):
        return "ExtractSVEvidenceSpark"

    def friendly_name(self) -> str:
        return "GATK4: ExtractSVEvidenceSpark"

    def tool(self) -> str:
        return "Gatk4ExtractSVEvidenceSpark"
    ...
    def inputs(self):
        return [
            ...
            ToolInput(
                ...
                prefix="--output",
                separate_value_from_prefix=True,
                doc=InputDocumentation(doc="(-O) HDFS path for output Required."),
            ),
            ToolInput(
                tag="adapterSequence",
                input_type=String(optional=True),
    ...
    def metadata(self):
        return ToolMetadata(
            contributors=[],
            dateCreated=datetime.fromisoformat("2020-05-18T15:02:39.035836"),
            dateUpdated=datetime.fromisoformat("2020-05-18T15:02:39.035838"),
            documentation="**BETA FEATURE - WORK IN PROGRESS**\nUSAGE: ExtractSVEvidenceSpark [arguments]\nThis tool is used in development and should not be of interest to most researchers.  It packages one step of the\nstructural variation workflow as a separate tool for the convenience of developers. This tool examines a SAM/BAM/CRAM\nfor reads, or groups of reads, that demonstrate evidence of a structural variation in the vicinity.  It records this\nevidence as a group of text files in a specified output directory on Spark's HDFS file system.\nVersion:4.1.3.0\n",
        )
