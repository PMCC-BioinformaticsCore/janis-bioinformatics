...
class GatkSplitSamByLibraryBase(Gatk4ToolBase, ABC):
    @classmethod
    def gatk_command(cls):
        return "SplitSamByLibrary"

    def friendly_name(self) -> str:
        return "GATK4: SplitSamByLibrary"

    def tool(self) -> str:
        return "Gatk4SplitSamByLibrary"
        ...
        return [
            ToolInput(
                ...
                doc=InputDocumentation(
                    doc="(-I) The SAM or BAM file to be split. Required."
                ),
            ),
            ToolInput(
                tag="arguments_file",
            ...
            ToolInput(
                ...
                separate_value_from_prefix=True,
                doc=InputDocumentation(
                    doc="(-O) The directory where the library SAM or BAM files should be written (defaults to the current directory).   Default value: /gatk/.. "
                ),
            ),
            ToolInput(
                tag="quiet",
    ...
    def metadata(self):
        return ToolMetadata(
            contributors=[],
            dateCreated=datetime.fromisoformat("2020-05-18T15:00:04.099311"),
            dateUpdated=datetime.fromisoformat("2020-05-18T15:00:04.099312"),
            documentation="b'USAGE: SplitSamByLibrary [arguments]\nTakes a SAM or BAM file and separates all the reads into one SAM or BAM file per library name.  Reads that do not have a\nread group specified or whose read group does not have a library name are written to a file called 'unknown.' The format\n(SAM or BAM) of the  output files matches that of the input file.<br /><h4>Usage example:</h4><pre>java -jar picard.jar\nSplitSamByLibrary <br />      I=input_reads.bam <br />      O=/output/directory/ <br /></pre>\nVersion:4.1.3.0\n",
        )
