...
class GatkIntervalListToBedBase(Gatk4ToolBase, ABC):
    @classmethod
    def gatk_command(cls):
        return "IntervalListToBed"

    def friendly_name(self) -> str:
        return "GATK4: IntervalListToBed"

    def tool(self) -> str:
        return "Gatk4IntervalListToBed"
    ...
    def inputs(self):
        return [
            ToolInput(
                ...
                doc=InputDocumentation(doc="(-I) Input IntervalList file. Required."),
            ),
            ToolInput(
                tag="outputFilename",
                ...
                prefix="--OUTPUT",
                separate_value_from_prefix=True,
                doc=InputDocumentation(doc="(-O) Output BED file. Required."),
            ),
            ToolInput(
                tag="arguments_file",
                input_type=File(optional=True),
            ...
            ToolInput(
                ...
                separate_value_from_prefix=True,
                doc=InputDocumentation(
                    doc="The score, between 0-1000, to output for each interval in the BED file. Default value: 500. "
                ),
            ),
            ToolInput(
                tag="sort",
                ...
                separate_value_from_prefix=True,
                doc=InputDocumentation(
                    doc="If true, sort the interval list prior to outputting as BED file. Default value: true. Possible values: {true, false} "
                ),
            ),
            ToolInput(
                tag="tmp_dir",
    ...
    def metadata(self):
        return ToolMetadata(
            contributors=[],
            dateCreated=datetime.fromisoformat("2020-05-18T14:53:33.589256"),
            dateUpdated=datetime.fromisoformat("2020-05-18T14:53:33.589258"),
            documentation="b'USAGE: IntervalListToBed [arguments]\nConverts an Picard IntervalList file to a BED file.\nVersion:4.1.3.0\n",
        )
