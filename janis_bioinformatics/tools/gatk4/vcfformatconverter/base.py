...
class GatkVcfFormatConverterBase(Gatk4ToolBase, ABC):
    @classmethod
    def gatk_command(cls):
        return "VcfFormatConverter"

    def friendly_name(self) -> str:
        return "GATK4: VcfFormatConverter"

    def tool(self) -> str:
        return "Gatk4VcfFormatConverter"
    ...
    def inputs(self):
        return [
            ToolInput(
                ...
                doc=InputDocumentation(doc="(-I) The BCF or VCF input file. Required."),
            ),
            ToolInput(
                tag="outputFilename",
                ...
                doc=InputDocumentation(
                    doc="(-O) The BCF or VCF output file name. Required."
                ),
            ),
            ToolInput(
                tag="arguments_file",
            ...
            ToolInput(
                ...
                separate_value_from_prefix=True,
                doc=InputDocumentation(
                    doc="Fail if an index is not available for the input VCF/BCF Default value: true. Possible values: {true, false} "
                ),
            ),
            ToolInput(
                tag="tmp_dir",
