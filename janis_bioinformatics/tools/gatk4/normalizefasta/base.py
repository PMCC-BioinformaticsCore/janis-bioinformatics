...
class GatkNormalizeFastaBase(Gatk4ToolBase, ABC):
    @classmethod
    def gatk_command(cls):
        return "NormalizeFasta"

    def friendly_name(self) -> str:
        return "GATK4: NormalizeFasta"

    def tool(self) -> str:
        return "Gatk4NormalizeFasta"
        ...
        return [
            ToolInput(
                ...
                doc=InputDocumentation(
                    doc="(-I) The input FASTA file to normalize. Required."
                ),
            ),
            ToolInput(
                tag="outputFilename",
                ...
                separate_value_from_prefix=True,
                doc=InputDocumentation(
                    doc="(-O) The output FASTA file to write. Required."
                ),
            ),
            ToolInput(
                tag="arguments_file",
            ...
            ToolInput(
                tag="truncate_sequence_names_at_whitespace",
                input_type=Boolean(optional=True),
                prefix="--TRUNCATE_SEQUENCE_NAMES_AT_WHITESPACE",
                separate_value_from_prefix=True,
                doc=InputDocumentation(
                    doc=" Truncate sequence names at first whitespace.  Default value: false. Possible values: {true, false} "
                ),
            ),
            ToolInput(
