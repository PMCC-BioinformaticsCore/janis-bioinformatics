...
class GatkCountBasesSparkBase(Gatk4ToolBase, ABC):
    @classmethod
    def gatk_command(cls):
        return "CountBasesSpark"

    def friendly_name(self) -> str:
        return "GATK4: CountBasesSpark"

    def tool(self) -> str:
        return "Gatk4CountBasesSpark"
    ...
    def metadata(self):
        return ToolMetadata(
            contributors=[],
            dateCreated=datetime.fromisoformat("2020-05-18T14:07:19.882422"),
            dateUpdated=datetime.fromisoformat("2020-05-18T14:07:19.882423"),
            documentation="USAGE: CountBasesSpark [arguments]\nCounts bases in the input SAM/BAM\nVersion:4.1.3.0\n",
        )
