...
class GatkClusterCrosscheckMetricsBase(Gatk4ToolBase, ABC):
    @classmethod
    def gatk_command(cls):
        return "ClusterCrosscheckMetrics"

    def friendly_name(self) -> str:
        return "GATK4: ClusterCrosscheckMetrics"

    def tool(self) -> str:
        return "Gatk4ClusterCrosscheckMetrics"
        ...
        return [
            ToolInput(
                ...
                doc=InputDocumentation(
                    doc="(-I) The cross-check metrics file to be clustered. Required."
                ),
            ),
            ToolInput(
                tag="arguments_file",
            ...
            ToolInput(
                ...
                separate_value_from_prefix=True,
                doc=InputDocumentation(
                    doc="(-LOD) LOD score to be used as the threshold for clustering. Default value: 0.0."
                ),
            ),
            ToolInput(
            ...
            ToolInput(
                ...
                separate_value_from_prefix=True,
                doc=InputDocumentation(
                    doc="(-O) Output file to write metrics to. Will write to stdout if null. Default value: null."
                ),
            ),
            ToolInput(
                tag="quiet",
