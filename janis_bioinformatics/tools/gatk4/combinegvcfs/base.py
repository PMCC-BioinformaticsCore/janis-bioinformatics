...
class GatkCombineGVCFsBase(Gatk4ToolBase, ABC):
    @classmethod
    def gatk_command(cls):
        return "CombineGVCFs"

    def friendly_name(self) -> str:
        return "GATK4: CombineGVCFs"

    def tool(self) -> str:
        return "Gatk4CombineGVCFs"
        ...
        return [
            ToolInput(
                ...
                doc=InputDocumentation(
                    doc="(-O) The combined GVCF output file Required."
                ),
            ),
            ToolInput(
                tag="reference",
            ...
            ToolInput(
                tag="breakBandsAtMultiplesOf",
                input_type=Int(optional=True),
                prefix="--break-bands-at-multiples-of",
                separate_value_from_prefix=True,
                doc=InputDocumentation(
                    doc=" If > 0, reference bands will be broken up at genomic positions that are multiples of this number  Default value: 0. "
                ),
            ),
            ToolInput(
            ...
            ToolInput(
                tag="convertToBasePairResolution",
                input_type=Boolean(optional=True),
                prefix="--convert-to-base-pair-resolution",
                separate_value_from_prefix=True,
                doc=InputDocumentation(
                    doc=" If specified, convert banded gVCFs to all-sites gVCFs  Default value: false. Possible values: {true, false} "
                ),
            ),
            ToolInput(
            ...
            ToolInput(
                tag="dropSomaticFilteringAnnotations",
                input_type=Boolean(optional=True),
                prefix="--drop-somatic-filtering-annotations",
                separate_value_from_prefix=True,
                doc=InputDocumentation(
                    doc=" For input somatic GVCFs (i.e. from Mutect2) drop filtering annotations  Default value: false. Possible values: {true, false} "
                ),
            ),
            ToolInput(
            ...
            ToolInput(
                ...
                separate_value_from_prefix=True,
                doc=InputDocumentation(
                    doc="Merge input GVCFs according to somatic (i.e. Mutect2) annotations (BETA) Default value: false. Possible values: {true, false} "
                ),
            ),
            ToolInput(
            ...
            ToolInput(
                tag="ignoreVariantsStartingOutsideInterval",
                input_type=Boolean(optional=True),
                prefix="--ignore-variants-starting-outside-interval",
                separate_value_from_prefix=True,
                doc=InputDocumentation(
                    doc=" Restrict variant output to sites that start within provided intervals (only applies when an interval is specified)  Default value: false. Possible values: {true, false} "
                ),
            ),
            ToolInput(
                tag="showhidden",
    ...
    def metadata(self):
        return ToolMetadata(
            contributors=[],
            dateCreated=datetime.fromisoformat("2020-05-18T15:01:36.489786"),
            dateUpdated=datetime.fromisoformat("2020-05-18T15:01:36.489788"),
            documentation="USAGE: CombineGVCFs [arguments]\nMerges one or more HaplotypeCaller GVCF files into a single GVCF with appropriate annotations\nVersion:4.1.3.0\n",
        )
