...
class GatkNonNFastaSizeBase(Gatk4ToolBase, ABC):
    @classmethod
    def gatk_command(cls):
        return "NonNFastaSize"

    def friendly_name(self) -> str:
        return "GATK4: NonNFastaSize"

    def tool(self) -> str:
        return "Gatk4NonNFastaSize"
    ...
    def inputs(self):
        return [
            ToolInput(
                ...
                doc=InputDocumentation(doc="(-I) The input FASTA file. Required."),
            ),
            ToolInput(
                tag="outputFilename",
                ...
                doc=InputDocumentation(
                    doc="(-O) The output file in which to record the count. Required."
                ),
            ),
            ToolInput(
                tag="arguments_file",
            ...
            ToolInput(
                ...
                separate_value_from_prefix=True,
                doc=InputDocumentation(
                    doc="(-INTERVALS) An interval list file that contains the locations of the positions to assess. If not provided, the entire reference will be used  Default value: null. "
                ),
            ),
            ToolInput(
