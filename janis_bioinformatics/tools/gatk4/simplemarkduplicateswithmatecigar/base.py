...
class GatkSimpleMarkDuplicatesWithMateCigarBase(Gatk4ToolBase, ABC):
    @classmethod
    def gatk_command(cls):
        return "SimpleMarkDuplicatesWithMateCigar"

    def friendly_name(self) -> str:
        return "GATK4: SimpleMarkDuplicatesWithMateCigar"

    def tool(self) -> str:
        return "Gatk4SimpleMarkDuplicatesWithMateCigar"
    ...
    def inputs(self):
        return [
            ...
            ToolInput(
                ...
                separate_value_from_prefix=True,
                doc=InputDocumentation(
                    doc="(-PG_NAME)  Value of PN tag of PG record to be created.  Default value: SimpleMarkDuplicatesWithMateCigar. "
                ),
            ),
            ToolInput(
    ...
    def metadata(self):
        return ToolMetadata(
            contributors=[],
            dateCreated=datetime.fromisoformat("2020-05-18T14:59:37.391877"),
            dateUpdated=datetime.fromisoformat("2020-05-18T14:59:37.391877"),
            documentation="b'\n**EXPERIMENTAL FEATURE - USE AT YOUR OWN RISK**\nUSAGE: SimpleMarkDuplicatesWithMateCigar [arguments]\nExamines aligned records in the supplied SAM or BAM file to locate duplicate molecules. All records are then written to\nthe output file with the duplicate records flagged.\nVersion:4.1.3.0\n",
        )
