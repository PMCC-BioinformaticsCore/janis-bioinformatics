...
class GatkValidateBasicSomaticShortMutationsBase(Gatk4ToolBase, ABC):
    @classmethod
    def gatk_command(cls):
        return "ValidateBasicSomaticShortMutations"

    def friendly_name(self) -> str:
        return "GATK4: ValidateBasicSomaticShortMutations"

    def tool(self) -> str:
        return "Gatk4ValidateBasicSomaticShortMutations"

    def inputs(self):
        return [
            ToolInput(
                tag="discoverySampleName",
            ...
            ToolInput(
                ...
                separate_value_from_prefix=True,
                doc=InputDocumentation(
                    doc="(-O) The output file, which will be a validation table (tsv). Required."
                ),
            ),
            ToolInput(
                tag="reference",
            ...
            ToolInput(
                ...
                separate_value_from_prefix=True,
                doc=InputDocumentation(
                    doc="Optional output vcf containing original variants annotated with validation info. Default value: null. "
                ),
            ),
            ToolInput(
                tag="arguments_file",
            ...
            ToolInput(
                ...
                separate_value_from_prefix=True,
                doc=InputDocumentation(
                    doc="(-DF)  Read filters to be disabled before analysis  This argument may be specified 0 or more times. Default value: null. Possible Values: {MappingQualityNotZeroReadFilter, NotDuplicateReadFilter, PassesVendorQualityCheckReadFilter, WellformedReadFilter}"
                ),
            ),
            ToolInput(
            ...
            ToolInput(
                tag="maxValidationNormalCount",
                input_type=Int(optional=True),
                prefix="--max-validation-normal-count",
                separate_value_from_prefix=True,
                doc=InputDocumentation(
                    doc=" Maximum read count in the validation normal for a variant to validate.  More counts is considered an artifact.  Default value: 1. "
                ),
            ),
            ToolInput(
                tag="minBaseQualityCutoff",
                input_type=Int(optional=True),
            ...
            ToolInput(
                ...
                separate_value_from_prefix=True,
                doc=InputDocumentation(
                    doc="Minimum power for an unvalidated variant to be considered a false positive. Default value: 0.9. "
                ),
            ),
            ToolInput(
                tag="quiet",
            ...
            ToolInput(
                ...
                separate_value_from_prefix=True,
                doc=InputDocumentation(
                    doc="A table of summary statistics (true positives, sensitivity, etc.) Default value: null."
                ),
            ),
            ToolInput(
                tag="tmpDir",
