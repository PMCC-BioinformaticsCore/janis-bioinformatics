...
class GatkPathSeqFilterSparkBase(Gatk4ToolBase, ABC):
    @classmethod
    def gatk_command(cls):
        return "PathSeqFilterSpark"

    def friendly_name(self) -> str:
        return "GATK4: PathSeqFilterSpark"

    def tool(self) -> str:
        return "Gatk4PathSeqFilterSpark"
    ...
    def inputs(self):
        return [
            ...
            ToolInput(
                ...
                separate_value_from_prefix=True,
                doc=InputDocumentation(
                    doc="(-PO) Output BAM containing only paired reads Default value: null."
                ),
            ),
            ToolInput(
                tag="programName",
            ...
            ToolInput(
                ...
                separate_value_from_prefix=True,
                doc=InputDocumentation(
                    doc="(-UO) Output BAM containing only unpaired reads Default value: null."
                ),
            ),
            ToolInput(
                tag="useJdkDeflater",
    ...
    def metadata(self):
        return ToolMetadata(
            contributors=[],
            dateCreated=datetime.fromisoformat("2020-05-18T14:54:20.330053"),
            dateUpdated=datetime.fromisoformat("2020-05-18T14:54:20.330054"),
            documentation="USAGE: PathSeqFilterSpark [arguments]\nFilters low complexity, low quality, duplicate, and host reads. First step in the PathSeq pipeline.\nVersion:4.1.3.0\n",
        )
