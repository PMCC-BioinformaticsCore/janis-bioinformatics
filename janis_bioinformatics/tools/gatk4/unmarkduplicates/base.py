...
class GatkUnmarkDuplicatesBase(Gatk4ToolBase, ABC):
    @classmethod
    def gatk_command(cls):
        return "UnmarkDuplicates"

    def friendly_name(self) -> str:
        return "GATK4: UnmarkDuplicates"

    def tool(self) -> str:
        return "Gatk4UnmarkDuplicates"
    ...
    def metadata(self):
        return ToolMetadata(
            contributors=[],
            dateCreated=datetime.fromisoformat("2020-05-18T15:00:23.587706"),
            dateUpdated=datetime.fromisoformat("2020-05-18T15:00:23.587708"),
            documentation="USAGE: UnmarkDuplicates [arguments]\nSimple tool to unmark duplicates in a SAM/BAM/CRAM file. Clears the 0x400 SAM flag bit on all reads.\nVersion:4.1.3.0\n",
        )
