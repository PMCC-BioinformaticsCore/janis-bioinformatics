...
class GatkExtractSequencesBase(Gatk4ToolBase, ABC):
    @classmethod
    def gatk_command(cls):
        return "ExtractSequences"

    def friendly_name(self) -> str:
        return "GATK4: ExtractSequences"

    def tool(self) -> str:
        return "Gatk4ExtractSequences"
    ...
    def inputs(self):
        return [
            ...
            ToolInput(
                ...
                prefix="--OUTPUT",
                separate_value_from_prefix=True,
                doc=InputDocumentation(doc="(-O) Output FASTA file. Required."),
            ),
            ToolInput(
