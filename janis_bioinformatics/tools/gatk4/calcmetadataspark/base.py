...
class GatkCalcMetadataSparkBase(Gatk4ToolBase, ABC):
    @classmethod
    def gatk_command(cls):
        return "CalcMetadataSpark"

    def friendly_name(self) -> str:
        return "GATK4: CalcMetadataSpark"

    def tool(self) -> str:
        return "Gatk4CalcMetadataSpark"
    ...
    def inputs(self):
        return [
            ...
            ToolInput(
                ...
                prefix="--output",
                separate_value_from_prefix=True,
                doc=InputDocumentation(doc="(-O) output file for metadata Required."),
            ),
            ToolInput(
            ...
            ToolInput(
                ...
                separate_value_from_prefix=True,
                doc=InputDocumentation(
                    doc="write metadata as serialized binary data, rather than as human-readable text Default value: false. Possible values: {true, false} "
                ),
            ),
            ToolInput(
    ...
    def metadata(self):
        return ToolMetadata(
            contributors=[],
            dateCreated=datetime.fromisoformat("2020-05-18T14:08:10.064585"),
            dateUpdated=datetime.fromisoformat("2020-05-18T14:08:10.064586"),
            documentation="**BETA FEATURE - WORK IN PROGRESS**\nUSAGE: CalcMetadataSpark [arguments]\nThis tool is used in development and should not be of interest to most researchers.  It executes the first step in the\nworkflow that the StructuralVariationDiscoveryPipelineSpark tool undertakes, but is packaged as a separately runnable\ntool for the convenience of developers. This tool takes a SAM/BAM/CRAM as input and calculates metrics about the reads:\nfragment length statistics by read group, mean length, coverage, partition statistics, etc.\nVersion:4.1.3.0\n",
        )
