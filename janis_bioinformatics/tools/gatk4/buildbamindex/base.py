...
class GatkBuildBamIndexBase(Gatk4ToolBase, ABC):
    @classmethod
    def gatk_command(cls):
        return "BuildBamIndex"

    def friendly_name(self) -> str:
        return "GATK4: BuildBamIndex"

    def tool(self) -> str:
        return "Gatk4BuildBamIndex"
        ...
        return [
            ToolInput(
                ...
                doc=InputDocumentation(
                    doc="(-I) A BAM file or GA4GH URL to process. Must be sorted in coordinate order. Required."
                ),
            ),
            ToolInput(
                tag="arguments_file",
            ...
            ToolInput(
                ...
                separate_value_from_prefix=True,
                doc=InputDocumentation(
                    doc="(-O) The BAM index file. Defaults to x.bai if INPUT is x.bam, otherwise INPUT.bai. If INPUT is a URL and OUTPUT is unspecified, defaults to a file in the current directory.  Default value: null. "
                ),
            ),
            ToolInput(
                tag="quiet",
