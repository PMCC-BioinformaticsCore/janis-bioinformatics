...
class Gatk4VariantFiltrationBase(Gatk4ToolBase):
    ...
    def friendly_name(self) -> str:
        return "GATK4: VariantFiltration"

    def tool(self) -> str:
        return "Gatk4Variantfiltration"
        ...
        return [
            *super().inputs(),
            ...
            ToolInput(
                ...
                separate_value_from_prefix=True,
                doc=InputDocumentation(
                    doc="(-cluster)  The number of SNPs which make up a cluster. Must be at least 2  Default value: 3. "
                ),
            ),
            ToolInput(
                tag="clusterWindowSize",
                input_type=Int(optional=True),
                prefix="--cluster-window-size",
                separate_value_from_prefix=True,
                doc=InputDocumentation(
                    doc="(-window)  The window size (in bases) in which to evaluate clustered SNPs  Default value: 0. "
                ),
            ),
            ToolInput(
            ...
            ToolInput(
                tag="genotypeFilterExpression",
                input_type=String(optional=True),
                prefix="--genotype-filter-expression",
                separate_value_from_prefix=True,
                doc=InputDocumentation(
                    doc="(-G-filter)  One or more expressions used with FORMAT (sample/genotype-level) fields to filter (see documentation guide for more info)  This argument may be specified 0 or more times. Default value: null. "
                ),
            ),
            ToolInput(
                tag="genotypeFilterName",
                input_type=String(optional=True),
                prefix="--genotype-filter-name",
                separate_value_from_prefix=True,
                doc=InputDocumentation(
                    doc="(-G-filter-name)  Names to use for the list of sample/genotype filters (must be a 1-to-1 mapping); this name is put in the FILTER field for variants that get filtered  This argument may be specified 0 or more times. Default value: null. "
                ),
            ),
            ToolInput(
                tag="help",
            ...
            ToolInput(
                tag="invertFilterExpression",
                input_type=Boolean(optional=True),
                prefix="--invert-filter-expression",
                separate_value_from_prefix=True,
                doc=InputDocumentation(
                    doc="(-invfilter)  Invert the selection criteria for --filter-expression  Default value: false. Possible values: {true, false} "
                ),
            ),
            ToolInput(
                tag="invertGenotypeFilterExpression",
                input_type=Boolean(optional=True),
                prefix="--invert-genotype-filter-expression",
                separate_value_from_prefix=True,
                doc=InputDocumentation(
                    doc="(-invG-filter)  Invert the selection criteria for --genotype-filter-expression  Default value: false. Possible values: {true, false} "
                ),
            ),
            ToolInput(
                tag="lenient",
            ...
            ToolInput(
                ...
                prefix="--mask",
                separate_value_from_prefix=True,
                doc=InputDocumentation(doc="(-mask) Input mask Default value: null."),
            ),
            ToolInput(
                tag="maskExtension",
                input_type=Int(optional=True),
            ...
            ToolInput(
                tag="missingValuesEvaluateAsFailing",
                input_type=Boolean(optional=True),
            ...
            ToolInput(
                tag="setFilteredGenotypeToNoCall",
                input_type=Boolean(optional=True),
