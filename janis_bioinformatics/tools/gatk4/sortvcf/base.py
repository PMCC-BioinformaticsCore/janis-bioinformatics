...
class GatkSortVcfBase(Gatk4ToolBase, ABC):
    @classmethod
    def gatk_command(cls):
        return "SortVcf"

    def friendly_name(self) -> str:
        return "GATK4: SortVcf"
        ...
        return [
            ToolInput(
                ...
                doc=InputDocumentation(
                    doc="(-I) Input VCF(s) to be sorted. Multiple inputs must have the same sample names (in order) This argument must be specified at least once. Required. "
                ),
            ),
            ToolInput(
                tag="outputFilename",
                ...
                prefix="--OUTPUT",
                separate_value_from_prefix=True,
                doc=InputDocumentation(doc="(-O) Output VCF to be written. Required."),
            ),
            ToolInput(
                tag="arguments_file",
                input_type=File(optional=True),
            ...
            ToolInput(
                ...
                separate_value_from_prefix=True,
                doc=InputDocumentation(doc="(-SD) Default value: null."),
            ),
            ToolInput(
                tag="tmp_dir",
                input_type=File(optional=True),
