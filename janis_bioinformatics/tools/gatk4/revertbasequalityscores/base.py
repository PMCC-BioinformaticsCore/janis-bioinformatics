...
class GatkRevertBaseQualityScoresBase(Gatk4ToolBase, ABC):
    @classmethod
    def gatk_command(cls):
        return "RevertBaseQualityScores"

    def friendly_name(self) -> str:
        return "GATK4: RevertBaseQualityScores"

    def tool(self) -> str:
        return "Gatk4RevertBaseQualityScores"
    ...
    def inputs(self):
        return [
            ...
            ToolInput(
                ...
                prefix="--output",
                separate_value_from_prefix=True,
                doc=InputDocumentation(doc="(-O) Write output to this file Required."),
            ),
            ToolInput(
    ...
    def metadata(self):
        return ToolMetadata(
            contributors=[],
            dateCreated=datetime.fromisoformat("2020-05-18T14:58:36.428003"),
            dateUpdated=datetime.fromisoformat("2020-05-18T14:58:36.428004"),
            documentation="USAGE: RevertBaseQualityScores [arguments]\nSimple tool to revert the quality scores in a SAM/BAM/CRAM file. Copies the scores from the OQ tag to the quality\nscores.\nVersion:4.1.3.0\n",
        )
