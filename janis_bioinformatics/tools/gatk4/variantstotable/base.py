...
class GatkVariantsToTableBase(Gatk4ToolBase, ABC):
    @classmethod
    def gatk_command(cls):
        return "VariantsToTable"

    def friendly_name(self) -> str:
        return "GATK4: VariantsToTable"

    def tool(self) -> str:
        return "Gatk4VariantsToTable"
        ...
        return [
            ToolInput(
                ...
                doc=InputDocumentation(
                    doc="(-O) File to which the tab-delimited table is written Required."
                ),
            ),
            ToolInput(
                tag="variant",
            ...
            ToolInput(
                tag="asfieldstotake",
                input_type=String(optional=True),
                prefix="--asFieldsToTake",
                separate_value_from_prefix=True,
                doc=InputDocumentation(
                    doc="(-ASF) The name of an allele-specific INFO field to be split if present This argument may be specified 0 or more times. Default value: null. "
                ),
            ),
            ToolInput(
                tag="asgenotypefieldstotake",
                input_type=String(optional=True),
                prefix="--asGenotypeFieldsToTake",
                separate_value_from_prefix=True,
                doc=InputDocumentation(
                    doc="(-ASGF)  The name of an allele-specific FORMAT field to be split if present  This argument may be specified 0 or more times. Default value: null. "
                ),
            ),
            ToolInput(
            ...
            ToolInput(
                ...
                separate_value_from_prefix=True,
                doc=InputDocumentation(
                    doc="(-F) The name of a standard VCF field or an INFO field to include in the output table This argument may be specified 0 or more times. Default value: null. "
                ),
            ),
            ToolInput(
                tag="gatkConfigFile",
            ...
            ToolInput(
                ...
                separate_value_from_prefix=True,
                doc=InputDocumentation(
                    doc="(-GF) The name of a genotype field to include in the output table This argument may be specified 0 or more times. Default value: null. "
                ),
            ),
            ToolInput(
                tag="help",
            ...
            ToolInput(
                ...
                separate_value_from_prefix=True,
                doc=InputDocumentation(
                    doc="(-SMA)  Split multi-allelic records into multiple lines  Default value: false. Possible values: {true, false} "
                ),
            ),
            ToolInput(
                tag="tmpDir",
            ...
            ToolInput(
                tag="errorIfMissingData",
                input_type=Boolean(optional=True),
                prefix="--error-if-missing-data",
                separate_value_from_prefix=True,
                doc=InputDocumentation(
                    doc="(-EMD)  Fail on missing data  Default value: false. Possible values: {true, false} "
                ),
            ),
            ToolInput(
                tag="moltenize",
                ...
                separate_value_from_prefix=True,
                doc=InputDocumentation(
                    doc="(-moltenize) Default value: false. Possible values: {true, false}"
                ),
            ),
            ToolInput(
                tag="showFiltered",
                ...
                separate_value_from_prefix=True,
                doc=InputDocumentation(
                    doc="(-raw) Include filtered records in the output Default value: false. Possible values: {true, false} "
                ),
            ),
            ToolInput(
                tag="showhidden",
    ...
    def metadata(self):
        return ToolMetadata(
            contributors=[],
            dateCreated=datetime.fromisoformat("2020-05-18T15:05:31.637130"),
            dateUpdated=datetime.fromisoformat("2020-05-18T15:05:31.637131"),
            documentation="USAGE: VariantsToTable [arguments]\nExtract specified fields for each variant in a VCF file to a tab-delimited table, which may be easier to work with than\na VCF\nVersion:4.1.3.0\n",
        )
