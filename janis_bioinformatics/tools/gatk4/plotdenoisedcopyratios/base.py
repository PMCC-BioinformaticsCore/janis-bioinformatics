...
class GatkPlotDenoisedCopyRatiosBase(Gatk4ToolBase, ABC):
    @classmethod
    def gatk_command(cls):
        return "PlotDenoisedCopyRatios"

    def friendly_name(self) -> str:
        return "GATK4: PlotDenoisedCopyRatios"

    def tool(self) -> str:
        return "Gatk4PlotDenoisedCopyRatios"
    ...
    def metadata(self):
        return ToolMetadata(
            contributors=[],
            dateCreated=datetime.fromisoformat("2020-05-18T14:06:04.355133"),
            dateUpdated=datetime.fromisoformat("2020-05-18T14:06:04.355134"),
            documentation="USAGE: PlotDenoisedCopyRatios [arguments]\nCreates plots of denoised copy ratios\nVersion:4.1.3.0\n",
        )
