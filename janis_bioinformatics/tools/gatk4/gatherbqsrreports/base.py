...
class GatkGatherBQSRReportsBase(Gatk4ToolBase, ABC):
    @classmethod
    ...
    def metadata(self):
        return ToolMetadata(
            contributors=[],
            dateCreated=datetime.fromisoformat("2020-05-18T14:54:53.051578"),
            dateUpdated=datetime.fromisoformat("2020-05-18T14:54:53.051579"),
