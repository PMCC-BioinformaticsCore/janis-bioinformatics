...
class GatkCompareIntervalListsBase(Gatk4ToolBase, ABC):
    @classmethod
    def gatk_command(cls):
        return "CompareIntervalLists"

    def friendly_name(self) -> str:
        return "GATK4: CompareIntervalLists"

    def tool(self) -> str:
        return "Gatk4CompareIntervalLists"
    ...
    def inputs(self):
        return [
            ToolInput(
                ...
                doc=InputDocumentation(doc="Undocumented option Required."),
            ),
            ToolInput(
                tag="list2",
                input_type=String(optional=True),
    ...
    def metadata(self):
        return ToolMetadata(
            contributors=[],
            dateCreated=datetime.fromisoformat("2020-05-18T14:53:28.088208"),
            dateUpdated=datetime.fromisoformat("2020-05-18T14:53:28.088209"),
            documentation="USAGE: CompareIntervalLists [arguments]\nCompare two interval lists to see if they are equal\nVersion:4.1.3.0\n",
        )
