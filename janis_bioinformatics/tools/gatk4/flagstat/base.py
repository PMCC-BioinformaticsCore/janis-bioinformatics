...
class GatkFlagStatBase(Gatk4ToolBase, ABC):
    @classmethod
    def gatk_command(cls):
        return "FlagStat"

    def friendly_name(self) -> str:
        return "GATK4: FlagStat"

    def tool(self) -> str:
        return "Gatk4FlagStat"
    ...
    def metadata(self):
        return ToolMetadata(
            contributors=[],
            dateCreated=datetime.fromisoformat("2020-05-18T14:12:15.134565"),
            dateUpdated=datetime.fromisoformat("2020-05-18T14:12:15.134566"),
            documentation="USAGE: FlagStat [arguments]\nAccumulate flag statistics given a BAM file, e.g. total number of reads with QC failure flag set, number of duplicates,\npercentage mapped etc.\nVersion:4.1.3.0\n",
        )
