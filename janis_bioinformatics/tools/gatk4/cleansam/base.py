...
class GatkCleanSamBase(Gatk4ToolBase, ABC):
    @classmethod
    def gatk_command(cls):
        return "CleanSam"

    def friendly_name(self) -> str:
        return "GATK4: CleanSam"

    def tool(self) -> str:
        return "Gatk4CleanSam"
    ...
    def inputs(self):
        return [
            ToolInput(
                ...
                doc=InputDocumentation(doc="(-I) Input SAM to be cleaned. Required."),
            ),
            ToolInput(
                tag="outputFilename",
                ...
                doc=InputDocumentation(
                    doc="(-O) Where to write cleaned SAM. Required."
                ),
            ),
            ToolInput(
                tag="arguments_file",
    ...
    def metadata(self):
        return ToolMetadata(
            contributors=[],
            dateCreated=datetime.fromisoformat("2020-05-18T14:56:26.976484"),
            dateUpdated=datetime.fromisoformat("2020-05-18T14:56:26.976486"),
            documentation="b'USAGE: CleanSam [arguments]\nCleans the provided SAM/BAM, soft-clipping beyond-end-of-reference alignments and setting MAPQ to 0 for unmapped reads\nVersion:4.1.3.0\n",
        )
