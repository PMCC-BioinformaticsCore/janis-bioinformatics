...
class GatkCollectQualityYieldMetricsSparkBase(Gatk4ToolBase, ABC):
    @classmethod
    def gatk_command(cls):
        return "CollectQualityYieldMetricsSpark"

    def friendly_name(self) -> str:
        return "GATK4: CollectQualityYieldMetricsSpark"

    def tool(self) -> str:
        return "Gatk4CollectQualityYieldMetricsSpark"
    ...
    def metadata(self):
        return ToolMetadata(
            contributors=[],
            dateCreated=datetime.fromisoformat("2020-05-18T14:10:22.586910"),
            dateUpdated=datetime.fromisoformat("2020-05-18T14:10:22.586910"),
            documentation="**BETA FEATURE - WORK IN PROGRESS**\nUSAGE: CollectQualityYieldMetricsSpark [arguments]\nCollects quality yield metrics from SAM/BAM/CRAM file(s). The tool leverages the Spark framework for faster operation.\nVersion:4.1.3.0\n",
        )
