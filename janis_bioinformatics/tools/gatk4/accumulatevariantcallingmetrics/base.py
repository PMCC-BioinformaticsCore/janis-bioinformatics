...
class GatkAccumulateVariantCallingMetricsBase(Gatk4ToolBase, ABC):
    @classmethod
    def gatk_command(cls):
        return "AccumulateVariantCallingMetrics"

    def friendly_name(self) -> str:
        return "GATK4: AccumulateVariantCallingMetrics"

    def tool(self) -> str:
        return "Gatk4AccumulateVariantCallingMetrics"
        ...
        return [
            ToolInput(
                ...
                doc=InputDocumentation(
                    doc="(-I) Paths (except for the file extensions) of Variant Calling Metrics files to read and merge. This argument must be specified at least once. Required. "
                ),
            ),
            ToolInput(
                tag="outputFilename",
