...
class GatkBwaMemIndexImageCreatorBase(Gatk4ToolBase, ABC):
    @classmethod
    def gatk_command(cls):
        return "BwaMemIndexImageCreator"

    def friendly_name(self) -> str:
        return "GATK4: BwaMemIndexImageCreator"

    def tool(self) -> str:
        return "Gatk4BwaMemIndexImageCreator"
        ...
        return [
            ToolInput(
                ...
                doc=InputDocumentation(
                    doc="(-I) Input reference FASTA file location. Required."
                ),
            ),
            ToolInput(
                tag="arguments_file",
            ...
            ToolInput(
                ...
                separate_value_from_prefix=True,
                doc=InputDocumentation(
                    doc="(-O) Output reference index image file (ending in '.img'). Default value: null."
                ),
            ),
            ToolInput(
                tag="quiet",
    ...
    def metadata(self):
        return ToolMetadata(
            contributors=[],
            dateCreated=datetime.fromisoformat("2020-05-18T15:00:36.925287"),
            dateUpdated=datetime.fromisoformat("2020-05-18T15:00:36.925288"),
            documentation="USAGE: BwaMemIndexImageCreator [arguments]\nCreate a BWA-MEM index image file for use with GATK BWA tools\nVersion:4.1.3.0\n",
        )
