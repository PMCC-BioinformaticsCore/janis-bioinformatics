...
class GatkFixVcfHeaderBase(Gatk4ToolBase, ABC):
    @classmethod
    def gatk_command(cls):
        return "FixVcfHeader"

    def friendly_name(self) -> str:
        return "GATK4: FixVcfHeader"

    def tool(self) -> str:
        return "Gatk4FixVcfHeader"
    ...
    def inputs(self):
        return [
            ToolInput(
                ...
                doc=InputDocumentation(doc="(-I) The input VCF/BCF file. Required."),
            ),
            ToolInput(
                tag="outputFilename",
                ...
                prefix="--OUTPUT",
                separate_value_from_prefix=True,
                doc=InputDocumentation(doc="(-O) The output VCF/BCF file. Required."),
            ),
            ToolInput(
                tag="arguments_file",
                input_type=File(optional=True),
            ...
            ToolInput(
                tag="check_first_n_records",
                input_type=Int(optional=True),
                prefix="--CHECK_FIRST_N_RECORDS",
                separate_value_from_prefix=True,
                doc=InputDocumentation(
                    doc="(-N)  Check only the first N records when searching for missing INFO and FORMAT fields.  Default value: -1. "
                ),
            ),
            ToolInput(
            ...
            ToolInput(
                tag="enforce_same_samples",
                input_type=Boolean(optional=True),
                prefix="--ENFORCE_SAME_SAMPLES",
                separate_value_from_prefix=True,
                doc=InputDocumentation(
                    doc=" header.  Default value: true. Possible values: {true, false} "
                ),
            ),
            ToolInput(
            ...
            ToolInput(
                ...
                separate_value_from_prefix=True,
                doc=InputDocumentation(
                    doc="(-H) The replacement VCF header. Default value: null."
                ),
            ),
            ToolInput(
                tag="help",
