...
class GatkPathSeqBwaSparkBase(Gatk4ToolBase, ABC):
    @classmethod
    def gatk_command(cls):
        return "PathSeqBwaSpark"

    def friendly_name(self) -> str:
        return "GATK4: PathSeqBwaSpark"

    def tool(self) -> str:
        return "Gatk4PathSeqBwaSpark"
    ...
    def metadata(self):
        return ToolMetadata(
            contributors=[],
            dateCreated=datetime.fromisoformat("2020-05-18T14:54:14.511788"),
            dateUpdated=datetime.fromisoformat("2020-05-18T14:54:14.511789"),
            documentation="USAGE: PathSeqBwaSpark [arguments]\nAlign reads to a microbe reference using BWA-MEM and Spark. Second step in the PathSeq pipeline.\nVersion:4.1.3.0\n",
        )
