...
class GatkPreprocessIntervalsBase(Gatk4ToolBase, ABC):
    @classmethod
    def gatk_command(cls):
        return "PreprocessIntervals"

    def friendly_name(self) -> str:
        return "GATK4: PreprocessIntervals"

    def tool(self) -> str:
        return "Gatk4PreprocessIntervals"
        ...
        return [
            ToolInput(
                ...
                doc=InputDocumentation(
                    doc="(-O) Output Picard interval-list file containing the preprocessed intervals. Required."
                ),
            ),
            ToolInput(
                tag="reference",
            ...
            ToolInput(
                ...
                separate_value_from_prefix=True,
                doc=InputDocumentation(
                    doc="Length (in bp) of the bins. If zero, no binning will be performed. Default value: 1000."
                ),
            ),
            ToolInput(
            ...
            ToolInput(
                ...
                separate_value_from_prefix=True,
                doc=InputDocumentation(
                    doc="Length (in bp) of the padding regions on each side of the intervals. Default value: 250."
                ),
            ),
            ToolInput(
                tag="quiet",
    ...
    def metadata(self):
        return ToolMetadata(
            contributors=[],
            dateCreated=datetime.fromisoformat("2020-05-18T14:53:50.294036"),
            dateUpdated=datetime.fromisoformat("2020-05-18T14:53:50.294037"),
            documentation="USAGE: PreprocessIntervals [arguments]\nPrepares bins for coverage collection\nVersion:4.1.3.0\n",
        )
