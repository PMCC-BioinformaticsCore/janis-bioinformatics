...
class GatkCompareMetricsBase(Gatk4ToolBase, ABC):
    @classmethod
    def gatk_command(cls):
        return "CompareMetrics"

    def friendly_name(self) -> str:
        return "GATK4: CompareMetrics"

    def tool(self) -> str:
        return "Gatk4CompareMetrics"
    ...
    def metadata(self):
        return ToolMetadata(
            contributors=[],
            dateCreated=datetime.fromisoformat("2020-05-19T08:37:53.571208"),
            dateUpdated=datetime.fromisoformat("2020-05-19T08:37:53.571209"),
            documentation="b'USAGE: CompareMetrics [arguments]\nCompare two metrics files.This tool compares the metrics and histograms generated from metric tools to determine if the\ngenerated results are identical.  This tool is useful to test and compare outputs when code changes are implemented. It\nis not meant for use by end-users of this toolkit.<br /><br />  The tool's output simply indicates whether two metrics\nfiles are equal or not equal. <br /> <h4>Usage example:</h4><pre>java -jar picard.jar CompareMetrics \\<br />     \nmetricfile1.txt \\<br />      metricfile2.txt</pre><hr />\nVersion:4.1.3.0\n",
        )
