...
class GatkVariantAnnotatorBase(Gatk4ToolBase, ABC):
    @classmethod
    def gatk_command(cls):
        return "VariantAnnotator"

    def friendly_name(self) -> str:
        return "GATK4: VariantAnnotator"
        ...
        return [
            ToolInput(
                ...
                doc=InputDocumentation(
                    doc="(-O) The file to whcih variants should be written Required."
                ),
            ),
            ToolInput(
                tag="variant",
            ...
            ToolInput(
                ...
                separate_value_from_prefix=True,
                doc=InputDocumentation(
                    doc="(-AX)  One or more specific annotations to exclude from variant calls  This argument may be specified 0 or more times. Default value: null. Any value allowed"
                ),
            ),
            ToolInput(
                tag="arguments_file",
            ...
            ToolInput(
                ...
                separate_value_from_prefix=True,
                doc=InputDocumentation(
                    doc="(-DF)  Read filters to be disabled before analysis  This argument may be specified 0 or more times. Default value: null. Possible Values: {MappedReadFilter, NotDuplicateReadFilter, PassesVendorQualityCheckReadFilter, PrimaryLineReadFilter, WellformedReadFilter}"
                ),
            ),
            ToolInput(
            ...
            ToolInput(
                ...
                separate_value_from_prefix=True,
                doc=InputDocumentation(
                    doc="(-E) One or more specific expressions to apply to variant calls This argument may be specified 0 or more times. Default value: null. "
                ),
            ),
            ToolInput(
                tag="founderId",
            ...
            ToolInput(
                ...
                separate_value_from_prefix=True,
                doc=InputDocumentation(
                    doc="External resource VCF file This argument may be specified 0 or more times. Default value: null. "
                ),
            ),
            ToolInput(
                tag="resourceAlleleConcordance",
                input_type=Boolean(optional=True),
                prefix="--resource-allele-concordance",
                separate_value_from_prefix=True,
                doc=InputDocumentation(
                    doc="(-rac)  Check for allele concordances when using an external resource VCF file  Default value: false. Possible values: {true, false} "
                ),
            ),
            ToolInput(
    ...
    def metadata(self):
        return ToolMetadata(
            contributors=[],
            dateCreated=datetime.fromisoformat("2020-05-18T15:08:35.691024"),
            dateUpdated=datetime.fromisoformat("2020-05-18T15:08:35.691025"),
