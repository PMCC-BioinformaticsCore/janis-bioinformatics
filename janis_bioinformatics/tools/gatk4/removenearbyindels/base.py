...
class GatkRemoveNearbyIndelsBase(Gatk4ToolBase, ABC):
    @classmethod
    def gatk_command(cls):
        return "RemoveNearbyIndels"

    def friendly_name(self) -> str:
        return "GATK4: RemoveNearbyIndels"

    def tool(self) -> str:
        return "Gatk4RemoveNearbyIndels"
    ...
    def inputs(self):
        return [
            ...
            ToolInput(
                ...
                separate_value_from_prefix=True,
                doc=InputDocumentation(
                    doc="(-min-indel-spacing)  Minimum spacing between neighboring indels to be emitted  Default value: 1. "
                ),
            ),
            ToolInput(
                tag="quiet",
    ...
    def metadata(self):
        return ToolMetadata(
            contributors=[],
            dateCreated=datetime.fromisoformat("2020-05-18T15:07:46.950112"),
            dateUpdated=datetime.fromisoformat("2020-05-18T15:07:46.950113"),
            documentation="USAGE: RemoveNearbyIndels [arguments]\nRemove indels that are close to each other from a vcf. For any pair of indels that are withinsome minimum allowed\ndistance, both indels are removed, regardless of any intervening non-indel variants.\nVersion:4.1.3.0\n",
        )
