...
class GatkCollectJumpingLibraryMetricsBase(Gatk4ToolBase, ABC):
    @classmethod
    def gatk_command(cls):
        return "CollectJumpingLibraryMetrics"

    def friendly_name(self) -> str:
        return "GATK4: CollectJumpingLibraryMetrics"

    def tool(self) -> str:
        return "Gatk4CollectJumpingLibraryMetrics"
        ...
        return [
            ToolInput(
                ...
                doc=InputDocumentation(
                    doc="(-I) BAM file(s) of reads with duplicates marked This argument must be specified at least once. Required. "
                ),
            ),
            ToolInput(
                tag="outputFilename",
                ...
                separate_value_from_prefix=True,
                doc=InputDocumentation(
                    doc="(-O) File to which metrics should be written Required."
                ),
            ),
            ToolInput(
                tag="arguments_file",
            ...
            ToolInput(
                ...
                separate_value_from_prefix=True,
                doc=InputDocumentation(
                    doc="Jumps greater than or equal to the greater of this value or 2 times the mode of the outward-facing pairs are considered chimeras  Default value: 100000. "
                ),
            ),
            ToolInput(
            ...
            ToolInput(
                ...
                separate_value_from_prefix=True,
                doc=InputDocumentation(
                    doc="(-MQ)  Mapping quality minimum cutoff  Default value: 0. "
                ),
            ),
            ToolInput(
                tag="quiet",
            ...
            ToolInput(
                ...
                separate_value_from_prefix=True,
                doc=InputDocumentation(
                    doc="(-T) When calculating mean and stdev stop when the bins in the tail of the distribution contain fewer than mode/TAIL_LIMIT items  Default value: 10000. "
                ),
            ),
            ToolInput(
                tag="tmp_dir",
