...
class GatkBwaAndMarkDuplicatesPipelineSparkBase(Gatk4ToolBase, ABC):
    @classmethod
    def gatk_command(cls):
        return "BwaAndMarkDuplicatesPipelineSpark"

    def friendly_name(self) -> str:
        return "GATK4: BwaAndMarkDuplicatesPipelineSpark"

    def tool(self) -> str:
        return "Gatk4BwaAndMarkDuplicatesPipelineSpark"
    ...
    def metadata(self):
        return ToolMetadata(
            contributors=[],
            dateCreated=datetime.fromisoformat("2020-05-18T14:56:13.521928"),
            dateUpdated=datetime.fromisoformat("2020-05-18T14:56:13.521929"),
            documentation="**BETA FEATURE - WORK IN PROGRESS**\nUSAGE: BwaAndMarkDuplicatesPipelineSpark [arguments]\nTakes name-sorted file and runs BWA and MarkDuplicates.\nVersion:4.1.3.0\n",
        )
