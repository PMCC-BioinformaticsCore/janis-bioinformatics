...
class GatkLeftAlignIndelsBase(Gatk4ToolBase, ABC):
    @classmethod
    def gatk_command(cls):
        return "LeftAlignIndels"

    def friendly_name(self) -> str:
        return "GATK4: LeftAlignIndels"

    def tool(self) -> str:
        return "Gatk4LeftAlignIndels"
    ...
    def inputs(self):
        return [
            ...
            ToolInput(
                ...
                prefix="--output",
                separate_value_from_prefix=True,
                doc=InputDocumentation(doc="(-O) Output BAM Required."),
            ),
            ToolInput(
                tag="reference",
                input_type=String(optional=True),
    ...
    def metadata(self):
        return ToolMetadata(
            contributors=[],
            dateCreated=datetime.fromisoformat("2020-05-18T14:57:27.686465"),
            dateUpdated=datetime.fromisoformat("2020-05-18T14:57:27.686466"),
            documentation="USAGE: LeftAlignIndels [arguments]\nLeft-aligns indels from reads in a SAM/BAM/CRAM file.\nVersion:4.1.3.0\n",
        )
