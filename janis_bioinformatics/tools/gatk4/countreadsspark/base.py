...
class GatkCountReadsSparkBase(Gatk4ToolBase, ABC):
    @classmethod
    def gatk_command(cls):
        return "CountReadsSpark"

    def friendly_name(self) -> str:
        return "GATK4: CountReadsSpark"

    def tool(self) -> str:
        return "Gatk4CountReadsSpark"
    ...
    def metadata(self):
        return ToolMetadata(
            contributors=[],
            dateCreated=datetime.fromisoformat("2020-05-18T14:07:32.882878"),
            dateUpdated=datetime.fromisoformat("2020-05-18T14:07:32.882879"),
            documentation="USAGE: CountReadsSpark [arguments]\nCounts reads in the input SAM/BAM\nVersion:4.1.3.0\n",
        )
