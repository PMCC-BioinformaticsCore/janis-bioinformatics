...
class GatkAddOriginalAlignmentTagsBase(Gatk4ToolBase, ABC):
    @classmethod
    def gatk_command(cls):
        return "AddOriginalAlignmentTags"

    def friendly_name(self) -> str:
        return "GATK4: AddOriginalAlignmentTags"

    def tool(self) -> str:
        return "Gatk4AddOriginalAlignmentTags"
    ...
    def metadata(self):
        return ToolMetadata(
            contributors=[],
            dateCreated=datetime.fromisoformat("2020-05-18T14:55:34.454678"),
            dateUpdated=datetime.fromisoformat("2020-05-18T14:55:34.454679"),
            documentation="**EXPERIMENTAL FEATURE - USE AT YOUR OWN RISK**\nUSAGE: AddOriginalAlignmentTags [arguments]\nAdds Original Alignment tag and original mate contig tag\nVersion:4.1.3.0\n",
        )
