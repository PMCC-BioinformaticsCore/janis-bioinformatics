...
class GatkFilterByOrientationBiasBase(Gatk4ToolBase, ABC):
    @classmethod
    def gatk_command(cls):
        return "FilterByOrientationBias"

    def friendly_name(self) -> str:
        return "GATK4: FilterByOrientationBias"

    def tool(self) -> str:
        return "Gatk4FilterByOrientationBias"
        ...
        return [
            ToolInput(
                ...
                doc=InputDocumentation(
                    doc="(-O) Output Somatic SNP/Indel VCF file Required."
                ),
            ),
            ToolInput(
                tag="preAdapterDetailFile",
                input_type=File(optional=True),
                prefix="--pre-adapter-detail-file",
                separate_value_from_prefix=True,
                doc=InputDocumentation(
                    doc="(-P)  PreAdapter Detail metrics file.  Usually, generated by CollectSequencingArtifactMetrics.  Required. "
                ),
            ),
            ToolInput(
                tag="variant",
            ...
            ToolInput(
                ...
                separate_value_from_prefix=True,
                doc=InputDocumentation(
                    doc="(-AM) PreAdapter Detail artifacts of interest on the forward strand. 'C/A' for a single artifact.  Specify this parameter multiple times to process multiple artifacts at the same time:  'C/A,T/G'  Artifacts must be one base to one base (e.g. 'CC/CA' is illegal).  G>T is OxoG.  This argument may be specified 0 or more times. Default value: null. "
                ),
            ),
            ToolInput(
