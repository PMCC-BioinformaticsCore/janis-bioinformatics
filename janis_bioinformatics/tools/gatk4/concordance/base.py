...
class GatkConcordanceBase(Gatk4ToolBase, ABC):
    @classmethod
    def gatk_command(cls):
        return "Concordance"

    def friendly_name(self) -> str:
        return "GATK4: Concordance"

    def tool(self) -> str:
        return "Gatk4Concordance"
    ...
    def inputs(self):
        return [
            ...
            ToolInput(
                ...
                separate_value_from_prefix=True,
                doc=InputDocumentation(
                    doc="A table of the contribution of each filter to true and false negatives Default value: null. "
                ),
            ),
            ToolInput(
                tag="filteredTrueNegativesAndFalseNegatives",
                input_type=File(optional=True),
                prefix="--filtered-true-negatives-and-false-negatives",
                separate_value_from_prefix=True,
                doc=InputDocumentation(
                    doc="(-ftnfn)  A vcf to write filtered true negatives and false negatives  Default value: null. "
                ),
            ),
            ToolInput(
                tag="gatkConfigFile",
            ...
            ToolInput(
                tag="truePositivesAndFalseNegatives",
                input_type=File(optional=True),
                prefix="--true-positives-and-false-negatives",
                separate_value_from_prefix=True,
                doc=InputDocumentation(
                    doc="(-tpfn)  A vcf to write true positives and false negatives  Default value: null. "
                ),
            ),
            ToolInput(
                tag="truePositivesAndFalsePositives",
                input_type=File(optional=True),
                prefix="--true-positives-and-false-positives",
                separate_value_from_prefix=True,
                doc=InputDocumentation(
                    doc="(-tpfp)  A vcf to write true positives and false positives  Default value: null. "
                ),
            ),
            ToolInput(
                tag="useJdkDeflater",
    ...
    def metadata(self):
        return ToolMetadata(
            contributors=[],
            dateCreated=datetime.fromisoformat("2020-05-18T15:03:48.437592"),
            dateUpdated=datetime.fromisoformat("2020-05-18T15:03:48.437593"),
