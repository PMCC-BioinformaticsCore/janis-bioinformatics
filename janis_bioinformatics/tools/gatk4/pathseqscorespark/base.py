...
class GatkPathSeqScoreSparkBase(Gatk4ToolBase, ABC):
    @classmethod
    def gatk_command(cls):
        return "PathSeqScoreSpark"

    def friendly_name(self) -> str:
        return "GATK4: PathSeqScoreSpark"

    def tool(self) -> str:
        return "Gatk4PathSeqScoreSpark"
    ...
    def inputs(self):
        return [
            ...
            ToolInput(
                ...
                separate_value_from_prefix=True,
                doc=InputDocumentation(
                    doc="(-PI) Input queryname-sorted BAM containing only paired reads Default value: null."
                ),
            ),
            ToolInput(
                tag="programName",
            ...
            ToolInput(
                ...
                separate_value_from_prefix=True,
                doc=InputDocumentation(
                    doc="(-UI) Input BAM containing only unpaired reads Default value: null."
                ),
            ),
            ToolInput(
                tag="useJdkDeflater",
    ...
    def metadata(self):
        return ToolMetadata(
            contributors=[],
            dateCreated=datetime.fromisoformat("2020-05-18T14:54:32.048081"),
            dateUpdated=datetime.fromisoformat("2020-05-18T14:54:32.048082"),
            documentation="USAGE: PathSeqScoreSpark [arguments]\nClassify reads and estimate abundances of each taxon in the reference. This is the third and final step of the PathSeq\npipeline.\nVersion:4.1.3.0\n",
        )
