...
class GatkCompareSAMsBase(Gatk4ToolBase, ABC):
    @classmethod
    def gatk_command(cls):
        return "CompareSAMs"

    def friendly_name(self) -> str:
        return "GATK4: CompareSAMs"

    def tool(self) -> str:
        return "Gatk4CompareSAMs"
