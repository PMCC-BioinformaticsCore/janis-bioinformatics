        ...
        return [
            *self.additional_inputs,
            ...
            ToolInput(
                ...
                Filename(),
                prefix="--out",
                doc='This option defines the output filename prefix for all files generated by vcftools. For example, if <prefix> is set  to  out-put_filename,  then  all  output  files will be of the form output_filename.*** . If this option is omitted, all output files will have the prefix "out." in the current working directory.',
            ),
        ]

    def outputs(self):
        return [ToolOutput("out", Vcf, glob=InputSelector("prefix") + ".recode.vcf")]
...
""".strip(),
    ...
    additional_inputs = [
        ...
        ToolInput("recode", Boolean(optional=True), prefix="--recode", doc=""),
        ToolInput(
            "recodeINFOAll",
            Boolean(optional=True),
