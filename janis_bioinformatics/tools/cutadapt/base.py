    ...
    additional_args = [
        ...
        ToolInput("adapter_g", String(optional=True), prefix="-g",
                  doc="Sequence of an adapter ligated to the 5' end (paired data: of the first read). "
                      ...
                      "prefix of the read."),
        ToolInput("adapter_both", String(optional=True), prefix="-b",
        ...
        ToolInput("qualityCutoff", Int(optional=True), prefix="-q",
        ...
        ToolInput("middleReadMatchFile", String(optional=True), prefix="-r",
