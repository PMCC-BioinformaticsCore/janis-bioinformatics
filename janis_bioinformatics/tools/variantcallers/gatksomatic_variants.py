...
from janis import Step, Input, Output, String
...
class GatkSomaticVariantCaller(BioinformaticsWorkflow):
    ...
    def __init__(self):
        ...
        self._metadata.keywords = ["variants", "gatk", "gatk4", "variant caller", "somatic"]
...
4. SplitMultiAllele
        ...
        s1_recal_normal = Step("baseRecalibrator_normal", gatk4.Gatk4BaseRecalibrator_4_0())
        s1_recal_tumor = Step("baseRecalibrator_tumor", gatk4.Gatk4BaseRecalibrator_4_0())
        ...
        for inp, baseRecal, applyBQSR in [(normal, s1_recal_normal, s2_applybqsr_normal),
